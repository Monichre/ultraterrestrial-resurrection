---
title: image-to-prompt — research-desk-ui-09 (inherited)
...
# Image-to-prompt — `research-desk-ui-09` (cluster-inherited)
...
→ **[research-desk-ui/image-to-prompt.md](../research-desk-ui/image-to-prompt.md)**

Cluster take: Product desk SoT (v2/v3, theory, living canvas, ledger)
