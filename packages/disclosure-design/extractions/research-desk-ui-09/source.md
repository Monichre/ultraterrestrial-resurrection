---
title: source — research-desk-ui-09
description: Provenance + pixel facts for research-desk-ui-09. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
- 1586×992 PNG · 1736 KB · mean luma 26.7 (dark register)
- median `#10181c` · dominant `#10191d` · chroma peak `#10191d`
- swatches: `#10191d` (18.5%), `#444b45` (3.9%)
...
- **Other Details**: original filename `research-desk-theory-canvas.png`
