---
title: image-to-prompt — journal-crop-handd-02 (inherited)
...
# Image-to-prompt — `journal-crop-handd-02` (cluster-inherited)
...
→ **[journal-crop-handd/image-to-prompt.md](../journal-crop-handd/image-to-prompt.md)**

Cluster take: Journal crop
