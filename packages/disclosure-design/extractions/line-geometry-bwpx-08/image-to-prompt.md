---
title: image-to-prompt — line-geometry-bwpx-08 (inherited)
...
# Image-to-prompt — `line-geometry-bwpx-08` (cluster-inherited)
...
→ **[line-geometry-bwpx/image-to-prompt.md](../line-geometry-bwpx/image-to-prompt.md)**

Cluster take: Line/geometry sibling batch
