---
title: image-to-prompt — near-black-geometry-04 (inherited)
...
# Image-to-prompt — `near-black-geometry-04` (cluster-inherited)
...
→ **[near-black-geometry/image-to-prompt.md](../near-black-geometry/image-to-prompt.md)**

Cluster take: Near-black geometry
