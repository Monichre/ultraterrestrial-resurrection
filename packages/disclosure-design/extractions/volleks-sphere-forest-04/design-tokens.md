---
title: design-tokens — volleks-sphere-forest-04
description: Pixel-grounded token sheet for volleks-sphere-forest-04 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `volleks-sphere-forest-04`

Source still: `./volleks-sphere-forest-04.png` · 1456×816 · PNG · polarity **dark** (mean luma 40.2).
