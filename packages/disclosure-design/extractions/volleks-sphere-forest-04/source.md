---
title: source — volleks-sphere-forest-04
description: Provenance + pixel facts for volleks-sphere-forest-04. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `volleks-sphere-forest-04`

> **Provenance: cluster-inherited.** This still was not individually vision-read.
> Cluster is homogeneous (same prompt / same set) — the take below is inherited from the gold rep [volleks-sphere-forest](../volleks-sphere-forest/) and is very likely accurate for this frame.

## Pixel facts (measured, this exact file)

- 1456×816 PNG · 1729 KB · mean luma 40.2 (dark register)
- median `#19212c` · dominant `#161c2a` · chroma peak `#161c2a`
- swatches: `#161c2a` (19.5%), `#293543` (16.7%), `#47545e` (9.7%)

## Cluster take (inherited)

Dark sphere / forest / VOLLEKS; blue–amber split
...
- **Aspects/Subjects/Motifs**: *inherited* — Dark sphere / forest / VOLLEKS; blue–amber split
- **Adjectives**: *pending*
...
- **Other Details**: original filename `u7869492466_httpss.mj.runie059vi5HP8_httpss.mj.runS0ZAvCLh_kI_15038641-5418-4c82-9188-8597024123e0_2.png`
