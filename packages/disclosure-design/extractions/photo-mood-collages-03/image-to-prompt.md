---
title: image-to-prompt — photo-mood-collages-03 (inherited)
...
# Image-to-prompt — `photo-mood-collages-03` (cluster-inherited)
...
→ **[photo-mood-collages/image-to-prompt.md](../photo-mood-collages/image-to-prompt.md)**

Cluster take: Photo collages (Rive/Seoul/coast/forest) — mood only
