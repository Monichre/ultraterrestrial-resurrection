---
title: image-to-prompt — case-file-dossier-covers-02 (inherited)
...
# Image-to-prompt — `case-file-dossier-covers-02` (cluster-inherited)
...
→ **[case-file-dossier-covers/image-to-prompt.md](../case-file-dossier-covers/image-to-prompt.md)**

Cluster take: Person-of-interest covers; archival stamps
