---
title: design-tokens — visual-language-report
description: Pixel-grounded token sheet for visual-language-report (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `visual-language-report`

Source still: `./visual-language-report.png` · 1055×1491 · PNG · polarity **light** (mean luma 145.8).
