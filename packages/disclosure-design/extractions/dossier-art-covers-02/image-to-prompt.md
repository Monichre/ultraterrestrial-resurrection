---
title: image-to-prompt — dossier-art-covers-02 (inherited)
...
# Image-to-prompt — `dossier-art-covers-02` (cluster-inherited)
...
→ **[dossier-art-covers/image-to-prompt.md](../dossier-art-covers/image-to-prompt.md)**

Cluster take: Manila folders, Socorro/Roswell covers, noir files
