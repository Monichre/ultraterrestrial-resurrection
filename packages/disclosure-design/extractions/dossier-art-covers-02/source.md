---
title: source — dossier-art-covers-02
description: Provenance + pixel facts for dossier-art-covers-02. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
- 1536×1024 PNG · 3068 KB · mean luma 59.0 (dark register)
- median `#3f3225` · dominant `#020201` · chroma peak `#020201`
- swatches: `#020201` (16.8%), `#705f49` (15.9%), `#a39075` (12.3%), `#847159` (12.2%), `#1e1914` (10.4%)
...
- **Other Details**: original filename `astronaut-secret-dossier.png`
