---
title: design-tokens — monochrome-height-luma-maps-05
description: Pixel-grounded token sheet for monochrome-height-luma-maps-05 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `monochrome-height-luma-maps-05`

Source still: `./monochrome-height-luma-maps-05.webp` · 512×1024 · WEBP · polarity **dark** (mean luma 25.0).
