---
title: image-to-prompt — monochrome-height-luma-maps-05 (inherited)
...
# Image-to-prompt — `monochrome-height-luma-maps-05` (cluster-inherited)
...
→ **[monochrome-height-luma-maps/image-to-prompt.md](../monochrome-height-luma-maps/image-to-prompt.md)**

Cluster take: Height/luma/speckle maps; near-black technical, not UI chrome
