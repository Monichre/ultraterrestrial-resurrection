---
title: source — near-black-geometry-02
description: Provenance + pixel facts for near-black-geometry-02. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `near-black-geometry-02`

> **Provenance: cluster-inherited.** This still was not individually vision-read.
> Cluster is homogeneous (same prompt / same set) — the take below is inherited from the gold rep [near-black-geometry](../near-black-geometry/) and is very likely accurate for this frame.

## Pixel facts (measured, this exact file)

- 928×1232 PNG · 332 KB · mean luma 1.8 (dark register)
- median `#000000` · dominant `#000000` · chroma peak `#1c1c1b`
- swatches: `#000000` (78.4%), `#1c1c1b` (2.9%)
...
- **Aspects/Subjects/Motifs**: *inherited* — Near-black geometry
- **Adjectives**: *pending*
...
- **Other Details**: original filename `u7869492466_httpss.mj.runvXtf5VcgeXU_Make_more_line_and_geome_4ea5a644-ecc8-45c5-b97b-29dc77f09e94_1.png`
