---
title: image-to-prompt — nebula-dotgrid-textures-02 (inherited)
...
# Image-to-prompt — `nebula-dotgrid-textures-02` (cluster-inherited)
...
→ **[nebula-dotgrid-textures/image-to-prompt.md](../nebula-dotgrid-textures/image-to-prompt.md)**

Cluster take: Nebula scanline, dot-grid, paper tooth siblings
