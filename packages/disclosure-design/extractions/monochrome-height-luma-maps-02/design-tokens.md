---
title: design-tokens — monochrome-height-luma-maps-02
description: Pixel-grounded token sheet for monochrome-height-luma-maps-02 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `monochrome-height-luma-maps-02`

Source still: `./monochrome-height-luma-maps-02.webp` · 1024×1024 · WEBP · polarity **dark** (mean luma 25.0).
...
| `--color-text-primary` | `#646464` | max-contrast swatch vs bg-primary (3.53:1) | ✅ high |
| `--color-text-secondary` | `#2e2e2e` | swatch ~60% between bg and text luma | ⚠️ medium |
...
| --- | --- | --- | --- |
| `#010101` | 31.9% | 0.0 | 1.0 |
| `#2e2e2e` | 15.0% | 0.0 | 46.0 |
| `#131313` | 12.5% | 0.0 | 19.0 |
| `#646464` | 9.4% | 0.0 | 100.0 |
