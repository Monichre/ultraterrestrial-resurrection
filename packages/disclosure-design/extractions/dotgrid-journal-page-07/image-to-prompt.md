---
title: image-to-prompt — dotgrid-journal-page-07 (inherited)
...
# Image-to-prompt — `dotgrid-journal-page-07` (cluster-inherited)
...
→ **[dotgrid-journal-page/image-to-prompt.md](../dotgrid-journal-page/image-to-prompt.md)**

Cluster take: Journal page, paper tooth
