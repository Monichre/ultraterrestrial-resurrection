---
title: source — mixed-mockup-plates-10
description: Provenance + pixel facts for mixed-mockup-plates-10. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
- 1764×1176 JPEG · 200 KB · mean luma 31.7 (dark register)
- median `#060913` · dominant `#588593` · chroma peak `#03060f`
- swatches: `#588593` (15.7%), `#03060f` (15.3%), `#0d2a27` (13.1%)
...
- **Other Details**: original filename `imgi_134_bg-motion-41.jpg`
