---
title: design-tokens — monochrome-height-luma-maps-30
description: Pixel-grounded token sheet for monochrome-height-luma-maps-30 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `monochrome-height-luma-maps-30`

Source still: `./monochrome-height-luma-maps-30.png` · 512×1024 · PNG · polarity **dark** (mean luma 27.0).
...
| --- | --- | --- | --- |
| `#000000` | 43.0% | 0.0 | 0.0 |
| `#1c1c1c` | 11.2% | 0.0 | 28.0 |
| `#363636` | 6.6% | 0.0 | 54.0 |
| `#585858` | 6.6% | 0.0 | 88.0 |
| `#999999` | 5.6% | 0.0 | 153.0 |
