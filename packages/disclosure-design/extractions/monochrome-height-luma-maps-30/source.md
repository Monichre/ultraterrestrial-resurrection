---
title: source — monochrome-height-luma-maps-30
description: Provenance + pixel facts for monochrome-height-luma-maps-30. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `monochrome-height-luma-maps-30`
...
- 512×1024 PNG · 215 KB · mean luma 27.0 (dark register)
- median `#070707` · dominant `#000000` · chroma peak `#000000`
- swatches: `#000000` (43.0%), `#1c1c1c` (11.2%), `#363636` (6.6%), `#585858` (6.6%), `#999999` (5.6%)
...
- **Other Details**: original filename `topo_waves_portrait_md_luma.png`
