---
title: source — daedalus-line-geometry-06
description: Provenance + pixel facts for daedalus-line-geometry-06. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `daedalus-line-geometry-06`
...
- 928×1232 PNG · 931 KB · mean luma 43.8 (dark register)
- median `#252525` · dominant `#252525` · chroma peak `#676d70`
- swatches: `#252525` (30.4%), `#676d70` (7.0%)
...
- **Other Details**: original filename `u7869492466_httpss.mj.runsZhUawvy0ak_Make_more_line_and_geome_857cc86c-eed1-42e6-844d-1a29209f3c78_0.png`
