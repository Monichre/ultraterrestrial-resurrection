---
title: source — astronaut-double-exposure-04
description: Provenance + pixel facts for astronaut-double-exposure-04. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `astronaut-double-exposure-04`

> **Provenance: cluster-inherited.** This still was not individually vision-read.
> Cluster is homogeneous (same prompt / same set) — the take below is inherited from the gold rep [astronaut-double-exposure](../astronaut-double-exposure/) and is very likely accurate for this frame.

## Pixel facts (measured, this exact file)

- 1456×816 PNG · 838 KB · mean luma 179.0 (light register)
- median `#d7cfbe` · dominant `#d7cfbf` · chroma peak `#5d463a`
- swatches: `#d7cfbf` (32.2%), `#5d463a` (14.9%), `#95805f` (10.7%)

## Cluster take (inherited)

High-key paper illustration
...
- **Aspects/Subjects/Motifs**: *inherited* — High-key paper illustration
- **Adjectives**: *pending*
...
- **Other Details**: original filename `u7869492466_imagine_A_double-exposure_illustration_of_an_astr_151b1703-ab51-47e3-b99f-4783ba7161eb_2.png`
