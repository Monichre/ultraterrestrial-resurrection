---
title: image-to-prompt — astronaut-double-exposure-04 (inherited)
...
# Image-to-prompt — `astronaut-double-exposure-04` (cluster-inherited)
...
→ **[astronaut-double-exposure/image-to-prompt.md](../astronaut-double-exposure/image-to-prompt.md)**

Cluster take: High-key paper illustration
