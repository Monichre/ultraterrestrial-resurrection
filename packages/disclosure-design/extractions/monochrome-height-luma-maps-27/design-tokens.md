---
title: design-tokens — monochrome-height-luma-maps-27
description: Pixel-grounded token sheet for monochrome-height-luma-maps-27 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `monochrome-height-luma-maps-27`

Source still: `./monochrome-height-luma-maps-27.png` · 1024×2048 · PNG · polarity **dark** (mean luma 26.0).
...
| --- | --- | --- | --- |
| `#000000` | 43.0% | 0.0 | 0.0 |
| `#2f2f2f` | 11.0% | 0.0 | 47.0 |
| `#585858` | 7.0% | 0.0 | 88.0 |
| `#171717` | 6.9% | 0.0 | 23.0 |
| `#999999` | 5.7% | 0.0 | 153.0 |
