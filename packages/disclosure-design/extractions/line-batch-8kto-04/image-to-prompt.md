---
title: image-to-prompt — line-batch-8kto-04 (inherited)
...
# Image-to-prompt — `line-batch-8kto-04` (cluster-inherited)
...
→ **[line-batch-8kto/image-to-prompt.md](../line-batch-8kto/image-to-prompt.md)**
