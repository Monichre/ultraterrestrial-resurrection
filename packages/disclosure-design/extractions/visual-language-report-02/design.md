---
title: design — visual-language-report-02 (inherited)
...
# Design — `visual-language-report-02` (cluster-inherited)
...
→ **[visual-language-report/design.md](../visual-language-report/design.md)**
