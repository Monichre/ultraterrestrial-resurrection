---
title: design-tokens — monochrome-height-luma-maps-14
description: Pixel-grounded token sheet for monochrome-height-luma-maps-14 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `monochrome-height-luma-maps-14`

Source still: `./monochrome-height-luma-maps-14.webp` · 2048×1024 · WEBP · polarity **dark** (mean luma 26.0).
...
| `--color-bg-secondary` | `#060606` | nearest-luma neighbor of bg-primary | ⚠️ medium |
