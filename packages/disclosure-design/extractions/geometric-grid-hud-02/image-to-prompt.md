---
title: image-to-prompt — geometric-grid-hud-02 (inherited)
...
# Image-to-prompt — `geometric-grid-hud-02` (cluster-inherited)
...
→ **[geometric-grid-hud/image-to-prompt.md](../geometric-grid-hud/image-to-prompt.md)**

Cluster take: Grid HUD with geometric line figure
