---
title: design-tokens — monochrome-height-luma-maps-19
description: Pixel-grounded token sheet for monochrome-height-luma-maps-19 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `monochrome-height-luma-maps-19`

Source still: `./monochrome-height-luma-maps-19.png` · 1024×512 · PNG · polarity **dark** (mean luma 26.0).
