---
title: image-to-prompt — prometheus-portrait-arrow-04 (inherited)
...
# Image-to-prompt — `prometheus-portrait-arrow-04` (cluster-inherited)
...
→ **[prometheus-portrait-arrow/image-to-prompt.md](../prometheus-portrait-arrow/image-to-prompt.md)**

Cluster take: Titan portrait + arrow
