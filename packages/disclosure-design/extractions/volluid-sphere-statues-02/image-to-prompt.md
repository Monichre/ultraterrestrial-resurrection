---
title: image-to-prompt — volluid-sphere-statues-02 (inherited)
...
# Image-to-prompt — `volluid-sphere-statues-02` (cluster-inherited)
...
→ **[volluid-sphere-statues/image-to-prompt.md](../volluid-sphere-statues/image-to-prompt.md)**

Cluster take: VOLLUID sphere + statues + grid
