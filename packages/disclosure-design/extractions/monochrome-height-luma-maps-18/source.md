---
title: source — monochrome-height-luma-maps-18
description: Provenance + pixel facts for monochrome-height-luma-maps-18. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `monochrome-height-luma-maps-18`
...
- 1024×512 PNG · 186 KB · mean luma 26.0 (dark register)
- median `#070707` · dominant `#000000` · chroma peak `#000000`
- swatches: `#000000` (41.5%), `#343434` (9.2%), `#585858` (8.8%), `#1d1d1d` (8.3%), `#9c9c9c` (4.8%)
...
- **Other Details**: original filename `data_cloud_landscape_md_height.png`
