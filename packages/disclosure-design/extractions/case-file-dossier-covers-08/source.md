---
title: source — case-file-dossier-covers-08
description: Provenance + pixel facts for case-file-dossier-covers-08. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `case-file-dossier-covers-08`
...
- 1232×928 PNG · 1387 KB · mean luma 87.5 (dark register)
- median `#0e0d17` · dominant `#000000` · chroma peak `#e1c39e`
- swatches: `#000000` (27.7%), `#e1c39e` (15.5%), `#63544a` (3.4%)
...
- **Other Details**: original filename `u7869492466_imagine_case_file_research_dossier_on_person_of_i_a11a688c-4725-4901-885f-fe9ed4120d29_2.png`
