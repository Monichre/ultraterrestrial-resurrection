---
title: design — case-file-dossier-covers-08 (inherited)
...
# Design — `case-file-dossier-covers-08` (cluster-inherited)
...
→ **[case-file-dossier-covers/design.md](../case-file-dossier-covers/design.md)**
