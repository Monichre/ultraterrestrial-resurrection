---
title: image-to-prompt — construction-light-variant-08 (inherited)
...
# Image-to-prompt — `construction-light-variant-08` (cluster-inherited)
...
→ **[construction-light-variant/image-to-prompt.md](../construction-light-variant/image-to-prompt.md)**

Cluster take: Lighter construction variant
