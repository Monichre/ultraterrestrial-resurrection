---
title: image-to-prompt — geometry-sibling-vxtf-03 (inherited)
...
# Image-to-prompt — `geometry-sibling-vxtf-03` (cluster-inherited)
...
→ **[geometry-sibling-vxtf/image-to-prompt.md](../geometry-sibling-vxtf/image-to-prompt.md)**

Cluster take: Geometry sibling
