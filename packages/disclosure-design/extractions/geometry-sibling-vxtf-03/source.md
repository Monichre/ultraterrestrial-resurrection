---
title: source — geometry-sibling-vxtf-03
description: Provenance + pixel facts for geometry-sibling-vxtf-03. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `geometry-sibling-vxtf-03`

> **Provenance: cluster-inherited.** This still was not individually vision-read.
> Cluster is homogeneous (same prompt / same set) — the take below is inherited from the gold rep [geometry-sibling-vxtf](../geometry-sibling-vxtf/) and is very likely accurate for this frame.

## Pixel facts (measured, this exact file)

- 928×1232 PNG · 531 KB · mean luma 3.0 (dark register)
- median `#000000` · dominant `#000000` · chroma peak `#1e2020`
- swatches: `#000000` (67.0%), `#1e2020` (5.5%)
...
- **Aspects/Subjects/Motifs**: *inherited* — Geometry sibling
- **Adjectives**: *pending*
...
- **Other Details**: original filename `u7869492466_httpss.mj.runvXtf5VcgeXU_httpss.mj.runAT2ktC5DWjo_47adeae6-e618-4a12-a0ac-18b9e4c9f787_2.png`
