---
title: source — near-black-element-collage-05
description: Provenance + pixel facts for near-black-element-collage-05. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `near-black-element-collage-05`
...
- 1232×928 PNG · 1595 KB · mean luma 19.7 (dark register)
- median `#02060a` · dominant `#000104` · chroma peak `#000104`
- swatches: `#000104` (15.6%), `#131a1f` (15.3%), `#5e5f60` (10.2%)
...
- **Other Details**: original filename `u7869492466_httpss.mj.runnzkeht6Sh_w_Using_the_elements_creat_672b7772-7e92-4050-b5b8-de64abf1460d_0.png`
