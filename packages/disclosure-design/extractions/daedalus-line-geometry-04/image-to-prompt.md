---
title: image-to-prompt — daedalus-line-geometry-04 (inherited)
...
# Image-to-prompt — `daedalus-line-geometry-04` (cluster-inherited)
...
→ **[daedalus-line-geometry/image-to-prompt.md](../daedalus-line-geometry/image-to-prompt.md)**

Cluster take: Daedalus/line geometry; DEDALUS bar; teal construction
