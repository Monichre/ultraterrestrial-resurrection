---
title: design-tokens — monochrome-height-luma-maps-16
description: Pixel-grounded token sheet for monochrome-height-luma-maps-16 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `monochrome-height-luma-maps-16`

Source still: `./monochrome-height-luma-maps-16.png` · 2048×1024 · PNG · polarity **dark** (mean luma 26.0).
