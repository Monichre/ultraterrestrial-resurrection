---
title: image-to-prompt — line-batch-dhyc-04 (inherited)
...
# Image-to-prompt — `line-batch-dhyc-04` (cluster-inherited)
...
→ **[line-batch-dhyc/image-to-prompt.md](../line-batch-dhyc/image-to-prompt.md)**
