---
title: image-to-prompt — split-classical-bust-02 (inherited)
...
# Image-to-prompt — `split-classical-bust-02` (cluster-inherited)
...
→ **[split-classical-bust/image-to-prompt.md](../split-classical-bust/image-to-prompt.md)**

Cluster take: Split classical bust
