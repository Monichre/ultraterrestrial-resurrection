---
title: image-to-prompt — martian-pyramid-interior-04 (inherited)
...
# Image-to-prompt — `martian-pyramid-interior-04` (cluster-inherited)
...
→ **[martian-pyramid-interior/image-to-prompt.md](../martian-pyramid-interior/image-to-prompt.md)**

Cluster take: Interior vast hall, cinematic
