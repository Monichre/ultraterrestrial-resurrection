---
title: design-tokens — mixed-mockup-plates-03
description: Pixel-grounded token sheet for mixed-mockup-plates-03 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `mixed-mockup-plates-03`

Source still: `./mixed-mockup-plates-03.png` · 1672×941 · PNG · polarity **dark** (mean luma 12.2).
