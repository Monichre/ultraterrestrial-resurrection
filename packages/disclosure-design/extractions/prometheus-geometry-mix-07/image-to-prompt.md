---
title: image-to-prompt — prometheus-geometry-mix-07 (inherited)
...
# Image-to-prompt — `prometheus-geometry-mix-07` (cluster-inherited)
...
→ **[prometheus-geometry-mix/image-to-prompt.md](../prometheus-geometry-mix/image-to-prompt.md)**

Cluster take: Prometheus/geometry mix
