---
title: image-to-prompt — hud-line-geometry-04 (inherited)
...
# Image-to-prompt — `hud-line-geometry-04` (cluster-inherited)
...
→ **[hud-line-geometry/image-to-prompt.md](../hud-line-geometry/image-to-prompt.md)**

Cluster take: Line/geometry HUD variants; mixed dark field + paper
