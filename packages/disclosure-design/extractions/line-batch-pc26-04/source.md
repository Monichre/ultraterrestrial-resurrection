---
title: source — line-batch-pc26-04
description: Provenance + pixel facts for line-batch-pc26-04. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `line-batch-pc26-04`

> **Provenance: cluster-inherited.** This still was not individually vision-read.
> Cluster is homogeneous (same prompt / same set) — the take below is inherited from the gold rep [line-batch-pc26](../line-batch-pc26/) and is very likely accurate for this frame.

## Pixel facts (measured, this exact file)

- 1232×928 PNG · 2037 KB · mean luma 95.4 (dark register)
- median `#86796c` · dominant `#b5ada3` · chroma peak `#070a0d`
- swatches: `#b5ada3` (16.3%), `#070a0d` (15.3%), `#95897c` (14.7%), `#504841` (5.9%)
...
- **Aspects/Subjects/Motifs**: *inherited* — Line batch
- **Adjectives**: *pending*
...
- **Other Details**: original filename `u7869492466_httpss.mj.runpC26JKid3xA_httpss.mj.runbPCsrT4C1do_944948e4-a8be-47d6-9a8b-4c26d38dcbae_3.png`
