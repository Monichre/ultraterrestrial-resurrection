---
title: source — monochrome-height-luma-maps-07
description: Provenance + pixel facts for monochrome-height-luma-maps-07. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `monochrome-height-luma-maps-07`
...
- 512×1024 PNG · 284 KB · mean luma 25.0 (dark register)
- median `#0e0e0e` · dominant `#010101` · chroma peak `#010101`
- swatches: `#010101` (25.8%), `#2d2d2d` (15.5%), `#131313` (11.3%), `#626262` (9.7%)
...
- **Other Details**: original filename `contour_mountains_portrait_jpeg_md_luma.png`
