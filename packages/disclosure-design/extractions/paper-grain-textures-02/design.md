---
title: design — paper-grain-textures-02 (inherited)
...
# Design — `paper-grain-textures-02` (cluster-inherited)
...
→ **[paper-grain-textures/design.md](../paper-grain-textures/design.md)**
