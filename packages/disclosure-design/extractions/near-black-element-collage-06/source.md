---
title: source — near-black-element-collage-06
description: Provenance + pixel facts for near-black-element-collage-06. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `near-black-element-collage-06`
...
- 1232×928 PNG · 1566 KB · mean luma 18.7 (dark register)
- median `#00050b` · dominant `#00030a` · chroma peak `#00030a`
- swatches: `#00030a` (22.0%), `#6e6d64` (8.6%)
...
- **Other Details**: original filename `u7869492466_httpss.mj.runnzkeht6Sh_w_Using_the_elements_creat_672b7772-7e92-4050-b5b8-de64abf1460d_1.png`
