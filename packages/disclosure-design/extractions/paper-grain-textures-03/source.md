---
title: source — paper-grain-textures-03
description: Provenance + pixel facts for paper-grain-textures-03. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `paper-grain-textures-03`

> **Provenance: cluster-inherited.** This still was not individually vision-read.
> Cluster is homogeneous (same prompt / same set) — the take below is inherited from the gold rep [paper-grain-textures](../paper-grain-textures/) and is very likely accurate for this frame.

## Pixel facts (measured, this exact file)

- 410×410 PNG · 55 KB · mean luma 183.0 (light register)
- median `#b6b6b6` · dominant `#b3b3b3` · chroma peak `#b3b3b3`
- swatches: `#b3b3b3` (16.3%), `#d6d6d6` (11.9%), `#9f9f9f` (9.3%)

## Cluster take (inherited)

Groove + inflicted grid paper
...
- **Aspects/Subjects/Motifs**: *inherited* — Groove + inflicted grid paper
- **Adjectives**: *pending*
...
- **Other Details**: original filename `fabric-of-squares.png`
