---
title: source — marcus-aurelius-dusk-04
description: Provenance + pixel facts for marcus-aurelius-dusk-04. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `marcus-aurelius-dusk-04`

> **Provenance: cluster-inherited.** This still was not individually vision-read.
> Cluster is homogeneous (same prompt / same set) — the take below is inherited from the gold rep [marcus-aurelius-dusk](../marcus-aurelius-dusk/) and is very likely accurate for this frame.

## Pixel facts (measured, this exact file)

- 1232×928 PNG · 2069 KB · mean luma 42.9 (dark register)
- median `#391a11` · dominant `#342313` · chroma peak `#342313`
- swatches: `#342313` (16.3%), `#110a0c` (13.7%), `#6b3f28` (12.5%), `#a67552` (10.8%)

## Cluster take (inherited)

Contemplative bust, dusk field
...
- **Aspects/Subjects/Motifs**: *inherited* — Contemplative bust, dusk field
- **Adjectives**: *pending*
...
- **Other Details**: original filename `u7869492466_Marcus_Aurelius_poses_contemplatively_late_in_his_5d9607f2-3d23-48d1-8f6e-4700001382ba_3.png`
