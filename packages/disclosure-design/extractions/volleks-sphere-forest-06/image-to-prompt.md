---
title: image-to-prompt — volleks-sphere-forest-06 (inherited)
...
# Image-to-prompt — `volleks-sphere-forest-06` (cluster-inherited)
...
→ **[volleks-sphere-forest/image-to-prompt.md](../volleks-sphere-forest/image-to-prompt.md)**

Cluster take: Dark sphere / forest / VOLLEKS; blue–amber split
