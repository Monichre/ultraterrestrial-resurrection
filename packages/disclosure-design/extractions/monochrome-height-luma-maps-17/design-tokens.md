---
title: design-tokens — monochrome-height-luma-maps-17
description: Pixel-grounded token sheet for monochrome-height-luma-maps-17 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `monochrome-height-luma-maps-17`

Source still: `./monochrome-height-luma-maps-17.webp` · 1024×512 · WEBP · polarity **dark** (mean luma 26.0).
