---
title: image-to-prompt — vintage-ultraterrestrial-document-02 (inherited)
...
# Image-to-prompt — `vintage-ultraterrestrial-document-02` (cluster-inherited)
...
→ **[vintage-ultraterrestrial-document/image-to-prompt.md](../vintage-ultraterrestrial-document/image-to-prompt.md)**

Cluster take: Archival document lettering
