---
title: design-tokens — monochrome-height-luma-maps-15
description: Pixel-grounded token sheet for monochrome-height-luma-maps-15 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `monochrome-height-luma-maps-15`

Source still: `./monochrome-height-luma-maps-15.png` · 2048×1024 · PNG · polarity **dark** (mean luma 26.0).
