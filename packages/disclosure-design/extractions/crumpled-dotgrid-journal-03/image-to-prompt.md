---
title: image-to-prompt — crumpled-dotgrid-journal-03 (inherited)
...
# Image-to-prompt — `crumpled-dotgrid-journal-03` (cluster-inherited)
...
→ **[crumpled-dotgrid-journal/image-to-prompt.md](../crumpled-dotgrid-journal/image-to-prompt.md)**

Cluster take: Dot-grid engineering journal, crumpled paper
