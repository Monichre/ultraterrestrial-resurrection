---
title: design — gateway-hero-explainer-02 (inherited)
...
# Design — `gateway-hero-explainer-02` (cluster-inherited)
...
→ **[gateway-hero-explainer/design.md](../gateway-hero-explainer/design.md)**
