---
title: image-to-prompt — gateway-hero-explainer-02 (inherited)
...
# Image-to-prompt — `gateway-hero-explainer-02` (cluster-inherited)
...
→ **[gateway-hero-explainer/image-to-prompt.md](../gateway-hero-explainer/image-to-prompt.md)**

Cluster take: Hero + process explainer (teal→red ladder)
