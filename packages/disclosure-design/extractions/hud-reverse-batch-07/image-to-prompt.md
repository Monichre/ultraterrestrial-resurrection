---
title: image-to-prompt — hud-reverse-batch-07 (inherited)
...
# Image-to-prompt — `hud-reverse-batch-07` (cluster-inherited)
...
→ **[hud-reverse-batch/image-to-prompt.md](../hud-reverse-batch/image-to-prompt.md)**

Cluster take: Reverse-prompt HUD batch
