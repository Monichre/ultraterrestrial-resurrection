---
title: image-to-prompt — ethereal-cosmic-background-03 (inherited)
...
# Image-to-prompt — `ethereal-cosmic-background-03` (cluster-inherited)
...
→ **[ethereal-cosmic-background/image-to-prompt.md](../ethereal-cosmic-background/image-to-prompt.md)**

Cluster take: Ethereal cosmic background
