---
title: design-tokens — spacetime-storyboards-02
description: Pixel-grounded token sheet for spacetime-storyboards-02 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `spacetime-storyboards-02`

Source still: `./spacetime-storyboards-02.png` · 1672×941 · PNG · polarity **dark** (mean luma 14.2).
