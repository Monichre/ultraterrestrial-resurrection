---
title: image-to-prompt — spacetime-storyboards-02 (inherited)
...
# Image-to-prompt — `spacetime-storyboards-02` (cluster-inherited)
...
→ **[spacetime-storyboards/image-to-prompt.md](../spacetime-storyboards/image-to-prompt.md)**

Cluster take: Spacetime / temporal-compare concepts
