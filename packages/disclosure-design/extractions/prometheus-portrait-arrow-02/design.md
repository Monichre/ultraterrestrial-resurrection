---
title: design — prometheus-portrait-arrow-02 (inherited)
...
# Design — `prometheus-portrait-arrow-02` (cluster-inherited)
...
→ **[prometheus-portrait-arrow/design.md](../prometheus-portrait-arrow/design.md)**
