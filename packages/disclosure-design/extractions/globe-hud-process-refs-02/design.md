---
title: design — globe-hud-process-refs-02 (inherited)
...
# Design — `globe-hud-process-refs-02` (cluster-inherited)
...
→ **[globe-hud-process-refs/design.md](../globe-hud-process-refs/design.md)**

Cluster take: Globe HUD + instruction layers
