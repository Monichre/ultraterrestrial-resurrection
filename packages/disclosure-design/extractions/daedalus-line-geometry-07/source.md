---
title: source — daedalus-line-geometry-07
description: Provenance + pixel facts for daedalus-line-geometry-07. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `daedalus-line-geometry-07`
...
- 928×1232 PNG · 848 KB · mean luma 12.9 (dark register)
- median `#08090b` · dominant `#0c0d0d` · chroma peak `#0c0d0d`
- swatches: `#0c0d0d` (34.9%), `#282d2f` (5.5%)
...
- **Other Details**: original filename `u7869492466_httpss.mj.runsZhUawvy0ak_Make_more_line_and_geome_857cc86c-eed1-42e6-844d-1a29209f3c78_1.png`
