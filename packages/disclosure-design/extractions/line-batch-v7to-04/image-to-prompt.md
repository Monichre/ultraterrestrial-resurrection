---
title: image-to-prompt — line-batch-v7to-04 (inherited)
...
# Image-to-prompt — `line-batch-v7to-04` (cluster-inherited)
...
→ **[line-batch-v7to/image-to-prompt.md](../line-batch-v7to/image-to-prompt.md)**
