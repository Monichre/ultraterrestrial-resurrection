---
title: source — mixed-mockup-plates-11
description: Provenance + pixel facts for mixed-mockup-plates-11. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
- 1920×1284 PNG · 2933 KB · mean luma 50.8 (dark register)
- median `#102626` · dominant `#1f3f35` · chroma peak `#08141c`
- swatches: `#1f3f35` (13.9%), `#08141c` (13.6%), `#326049` (12.8%), `#6fb389` (10.8%)
...
- **Other Details**: original filename `imgi_150_motion-41.png`
