---
title: image-to-prompt — bust-starfield-construction-03 (inherited)
...
# Image-to-prompt — `bust-starfield-construction-03` (cluster-inherited)
...
→ **[bust-starfield-construction/image-to-prompt.md](../bust-starfield-construction/image-to-prompt.md)**

Cluster take: Classical bust + starfield + construction overlay
