---
title: image-to-prompt — prometheus-sketch-sibling-04 (inherited)
...
# Image-to-prompt — `prometheus-sketch-sibling-04` (cluster-inherited)
...
→ **[prometheus-sketch-sibling/image-to-prompt.md](../prometheus-sketch-sibling/image-to-prompt.md)**

Cluster take: Prometheus sketch sibling
