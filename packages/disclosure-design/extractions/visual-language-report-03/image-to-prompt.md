---
title: image-to-prompt — visual-language-report-03 (inherited)
...
# Image-to-prompt — `visual-language-report-03` (cluster-inherited)
...
→ **[visual-language-report/image-to-prompt.md](../visual-language-report/image-to-prompt.md)**

Cluster take: VL report + archive territory map
