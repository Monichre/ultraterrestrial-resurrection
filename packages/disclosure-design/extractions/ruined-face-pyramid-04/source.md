---
title: source — ruined-face-pyramid-04
description: Provenance + pixel facts for ruined-face-pyramid-04. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `ruined-face-pyramid-04`

> **Provenance: cluster-inherited.** This still was not individually vision-read.
> Cluster is homogeneous (same prompt / same set) — the take below is inherited from the gold rep [ruined-face-pyramid](../ruined-face-pyramid/) and is very likely accurate for this frame.

## Pixel facts (measured, this exact file)

- 1680×720 PNG · 1748 KB · mean luma 32.8 (dark register)
- median `#0d191b` · dominant `#26342e` · chroma peak `#0b1f1e`
- swatches: `#26342e` (15.8%), `#0b1f1e` (14.5%), `#4a6d4e` (8.6%)

## Cluster take (inherited)

Sickly green/orange ruins
...
- **Aspects/Subjects/Motifs**: *inherited* — Sickly green/orange ruins
- **Adjectives**: *pending*
...
- **Other Details**: original filename `u7869492466_The_ruined_Face_and_pyramid_bathed_in_a_sickly_gr_b640bc12-ee48-4ac1-bd04-78120d94d975_2.png`
