---
title: image-to-prompt — paper-grain-textures-05 (inherited)
...
# Image-to-prompt — `paper-grain-textures-05` (cluster-inherited)
...
→ **[paper-grain-textures/image-to-prompt.md](../paper-grain-textures/image-to-prompt.md)**

Cluster take: Groove + inflicted grid paper
