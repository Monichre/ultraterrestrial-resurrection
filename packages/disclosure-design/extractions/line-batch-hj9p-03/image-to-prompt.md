---
title: image-to-prompt — line-batch-hj9p-03 (inherited)
...
# Image-to-prompt — `line-batch-hj9p-03` (cluster-inherited)
...
→ **[line-batch-hj9p/image-to-prompt.md](../line-batch-hj9p/image-to-prompt.md)**
