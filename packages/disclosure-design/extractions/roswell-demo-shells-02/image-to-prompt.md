---
title: image-to-prompt — roswell-demo-shells-02 (inherited)
...
# Image-to-prompt — `roswell-demo-shells-02` (cluster-inherited)
...
→ **[roswell-demo-shells/image-to-prompt.md](../roswell-demo-shells/image-to-prompt.md)**

Cluster take: Roswell demo shell
