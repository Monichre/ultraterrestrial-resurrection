---
title: design — lovecraft-dossier-split-02 (inherited)
...
# Design — `lovecraft-dossier-split-02` (cluster-inherited)
...
→ **[lovecraft-dossier-split/design.md](../lovecraft-dossier-split/design.md)**

Cluster take: Lovecraft dossier split
