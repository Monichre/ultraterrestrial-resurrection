---
title: image-to-prompt — prometheus-line-studies-02 (inherited)
...
# Image-to-prompt — `prometheus-line-studies-02` (cluster-inherited)
...
→ **[prometheus-line-studies/image-to-prompt.md](../prometheus-line-studies/image-to-prompt.md)**

Cluster take: Identity line drawings; hairline grid; dark + paper registers
