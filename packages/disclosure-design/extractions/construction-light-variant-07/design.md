---
title: design — construction-light-variant-07 (inherited)
...
# Design — `construction-light-variant-07` (cluster-inherited)
...
→ **[construction-light-variant/design.md](../construction-light-variant/design.md)**
