---
title: image-to-prompt — spy-lab-variant-6ymm-03 (inherited)
...
# Image-to-prompt — `spy-lab-variant-6ymm-03` (cluster-inherited)
...
→ **[spy-lab-variant-6ymm/image-to-prompt.md](../spy-lab-variant-6ymm/image-to-prompt.md)**

Cluster take: Spy-lab variant
