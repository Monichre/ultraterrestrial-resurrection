---
title: design-tokens — research-desk-ui-07
description: Pixel-grounded token sheet for research-desk-ui-07 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `research-desk-ui-07`

Source still: `./research-desk-ui-07.png` · 1586×992 · PNG · polarity **dark** (mean luma 26.7).
