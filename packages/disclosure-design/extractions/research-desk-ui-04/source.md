---
title: source — research-desk-ui-04
description: Provenance + pixel facts for research-desk-ui-04. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
# Source — `research-desk-ui-04`

> **Provenance: cluster-inherited.** This still was not individually vision-read.
> Cluster is homogeneous (same prompt / same set) — the take below is inherited from the gold rep [research-desk-ui](../research-desk-ui/) and is very likely accurate for this frame.

## Pixel facts (measured, this exact file)

- 1440×960 PNG · 198 KB · mean luma 27.5 (dark register)
- median `#15181a` · dominant `#161a1b` · chroma peak `#161a1b`
- swatches: `#161a1b` (18.3%), `#393b3a` (10.2%)

## Cluster take (inherited)

Product desk SoT (v2/v3, theory, living canvas, ledger)
...
- **Aspects/Subjects/Motifs**: *inherited* — Product desk SoT (v2/v3, theory, living canvas, ledger)
- **Adjectives**: *pending*
...
- **Other Details**: original filename `hypothesis-lab-competing-explanations.png`
