---
title: design — monochrome-height-luma-maps-04 (inherited)
...
# Design — `monochrome-height-luma-maps-04` (cluster-inherited)
...
→ **[monochrome-height-luma-maps/design.md](../monochrome-height-luma-maps/design.md)**
