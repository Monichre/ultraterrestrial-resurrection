---
title: design-tokens — monochrome-height-luma-maps-04
description: Pixel-grounded token sheet for monochrome-height-luma-maps-04 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `monochrome-height-luma-maps-04`

Source still: `./monochrome-height-luma-maps-04.png` · 1024×1024 · PNG · polarity **dark** (mean luma 25.0).
...
| `--color-text-primary` | `#636363` | max-contrast swatch vs bg-primary (3.47:1) | ✅ high |
...
| --- | --- | --- | --- |
| `#010101` | 27.0% | 0.0 | 1.0 |
| `#2e2e2e` | 14.9% | 0.0 | 46.0 |
| `#131313` | 11.6% | 0.0 | 19.0 |
| `#636363` | 9.5% | 0.0 | 99.0 |
