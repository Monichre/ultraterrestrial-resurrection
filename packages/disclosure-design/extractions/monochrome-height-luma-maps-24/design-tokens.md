---
title: design-tokens — monochrome-height-luma-maps-24
description: Pixel-grounded token sheet for monochrome-height-luma-maps-24 (Pillow median-cut sample + assembling-components canon).
type: note
created: 2026-08-13
author: agent
...
# Design tokens — `monochrome-height-luma-maps-24`

Source still: `./monochrome-height-luma-maps-24.png` · 1024×512 · PNG · polarity **dark** (mean luma 14.0).
...
| `--color-text-primary` | `#191919` | max-contrast swatch vs bg-primary (1.17:1) | ✅ high |
