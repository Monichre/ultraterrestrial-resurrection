---
title: design — dotgrid-journal-page-06 (inherited)
...
# Design — `dotgrid-journal-page-06` (cluster-inherited)
...
→ **[dotgrid-journal-page/design.md](../dotgrid-journal-page/design.md)**
