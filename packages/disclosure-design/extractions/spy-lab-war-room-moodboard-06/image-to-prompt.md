---
title: image-to-prompt — spy-lab-war-room-moodboard-06 (inherited)
...
# Image-to-prompt — `spy-lab-war-room-moodboard-06` (cluster-inherited)
...
→ **[spy-lab-war-room-moodboard/image-to-prompt.md](../spy-lab-war-room-moodboard/image-to-prompt.md)**

Cluster take: Evidence wall, manila + stamp red
