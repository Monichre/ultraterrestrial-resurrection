---
title: design — spy-lab-war-room-moodboard-06 (inherited)
...
# Design — `spy-lab-war-room-moodboard-06` (cluster-inherited)
...
→ **[spy-lab-war-room-moodboard/design.md](../spy-lab-war-room-moodboard/design.md)**
