---
title: image-to-prompt — bust-geometry-reverse-02 (inherited)
...
# Image-to-prompt — `bust-geometry-reverse-02` (cluster-inherited)
...
→ **[bust-geometry-reverse/image-to-prompt.md](../bust-geometry-reverse/image-to-prompt.md)**

Cluster take: Bust/geometry reverse
