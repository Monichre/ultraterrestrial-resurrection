---
title: image-to-prompt — nasa-dossier-1978-02 (inherited)
...
# Image-to-prompt — `nasa-dossier-1978-02` (cluster-inherited)
...
→ **[nasa-dossier-1978/image-to-prompt.md](../nasa-dossier-1978/image-to-prompt.md)**

Cluster take: Magenta RECEIVED stamp — decorative
