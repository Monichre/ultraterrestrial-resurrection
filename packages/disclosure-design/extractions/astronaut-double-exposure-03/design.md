---
title: design — astronaut-double-exposure-03 (inherited)
...
# Design — `astronaut-double-exposure-03` (cluster-inherited)
...
→ **[astronaut-double-exposure/design.md](../astronaut-double-exposure/design.md)**
