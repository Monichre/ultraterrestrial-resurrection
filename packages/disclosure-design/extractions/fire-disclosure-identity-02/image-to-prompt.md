---
title: image-to-prompt — fire-disclosure-identity-02 (inherited)
...
# Image-to-prompt — `fire-disclosure-identity-02` (cluster-inherited)
...
→ **[fire-disclosure-identity/image-to-prompt.md](../fire-disclosure-identity/image-to-prompt.md)**

Cluster take: Fire identity plate
