---
title: source — mixed-mockup-plates-13
description: Provenance + pixel facts for mixed-mockup-plates-13. Vision not yet per-image; cluster-inherited take marked honestly.
type: note
created: 2026-08-13
author: agent
...
- 1920×1080 JPEG · 161 KB · mean luma 23.4 (dark register)
- median `#10120f` · dominant `#10120f` · chroma peak `#10120f`
- swatches: `#10120f` (67.9%), `#52554e` (7.2%)
...
- **Other Details**: original filename `imgi_9_bg-20260506-1.jpg`
