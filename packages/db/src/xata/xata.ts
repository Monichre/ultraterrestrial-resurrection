...
const tables = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "processed", type: "bool", defaultValue: "false" },
    ],
    revLinks: [
      { column: "document", table: "user-saved-documents" },
      { column: "document", table: "summary-files" },
    ],
  },
  {
    name: "locations",
...
export type KeyFigures = InferredTypes["key-figures"];
export type KeyFiguresRecord = KeyFigures & XataRecord;

export type SummaryFiles = InferredTypes["summary-files"];
export type SummaryFilesRecord = SummaryFiles & XataRecord;
