      ...
      <Tabs defaultValue="connections" className="w-full h-full flex flex-col">
        <div className="border-b border-neutral-800 p-4">
          <TabsList className="bg-neutral-900/50 border border-neutral-800">
            <TabsTrigger value="connections" className="data-[state=active]:bg-neutral-800">
              <Network className="h-4 w-4 mr-2" />
              Drawing board
            </TabsTrigger>
            <TabsTrigger value="browser" className="data-[state=active]:bg-neutral-800">
        ...
        <TabsContent value="details" className="mt-0 flex-1 h-full overflow-hidden">
          <DeskFiles />
        </TabsContent>
      </Tabs>
    </Card>
