  ...
  return (
    <motion.svg
      ...
      <motion.path
        ...
        transition={transition}
        d="M8.69667 0.0403541C8.90859 0.131038 9.03106 0.354857 8.99316 0.582235L8.0902 6.00001H12.5C12.6893 6.00001 12.8625 6.10701 12.9472 6.27641C13.0319 6.4458 13.0136 6.6485 12.8999 6.80001L6.89997 14.8C6.76167 14.9844 6.51521 15.0503 6.30328 14.9597C6.09135 14.869 5.96888 14.6452 6.00678 14.4178L6.90974 9H2.49999C2.31061 9 2.13748 8.893 2.05278 8.72361C1.96809 8.55422 1.98636 8.35151 2.09999 8.2L8.09997 0.200038C8.23828 0.0156255 8.48474 -0.0503301 8.69667 0.0403541ZM3.49999 8.00001H7.49997C7.64695 8.00001 7.78648 8.06467 7.88148 8.17682C7.97648 8.28896 8.01733 8.43723 7.99317 8.5822L7.33027 12.5596L11.5 7.00001H7.49997C7.353 7.00001 7.21347 6.93534 7.11846 6.8232C7.02346 6.71105 6.98261 6.56279 7.00678 6.41781L7.66968 2.44042L3.49999 8.00001Z" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd">
      </motion.path>
    </motion.svg>
  )
}
...
export const FlyingSaucerIcon = ( { stroke = ICON_BLUE, fill = 'none', className, onClick }: IconProps ) => {
  const config = iconAnimationConfig( { stroke: ICON_BLUE } )
  return (
    <motion.svg width="24"
      stroke={stroke}
...
export const UFOIcon = ( { stroke = ICON_BLUE, fill = 'none', className, onClick, ...props }: IconProps ) => {
  const config = iconAnimationConfig( { stroke } )
  return (
    <motion.svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
      stroke={stroke}
    ...
    >
      <motion.path initial={{ pathLength: 0.001 }}
        stroke={stroke}
        animate={{ pathLength: 1 }}
        transition={transition} d="M6.85467 10.408C5.34979 11.5973 4.52773 12.9733 4.80246 14.1495C5.27992 16.1938 8.88944 16.8604 12.8645 15.6385C16.8396 14.4166 19.675 11.7688 19.1975 9.7246C18.9572 8.6957 17.9235 8.01578 16.449 7.75L15.9492 7.66016" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path stroke={stroke} initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M16.75 17.75L18.25 19.25" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path stroke={stroke} initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M13.75 18.75L14.25 19.25" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path stroke={stroke} initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M18.75 15.75L19.25 16.25" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
      <motion.path stroke={stroke} initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition} d="M10.5003 4.90074L9.97512 5.04283C7.65461 5.67062 6.27752 8.07889 6.8993 10.4218L7.04259 10.9618C7.2165 11.6171 7.71414 12.1392 8.38877 12.2068C9.22364 12.2906 10.5035 12.2886 12.0672 11.8655C13.6387 11.4404 14.7514 10.7916 15.4321 10.2967C15.9766 9.90072 16.146 9.20539 15.9733 8.55469L15.8278 8.00632C15.206 5.66336 12.8208 4.27295 10.5003 4.90074Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></motion.path>
    </motion.svg>
  )
}
...
export const DotIcon = ( { stroke = 'currentColor', className }: IconProps ) => {
  return (
    <motion.svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      <motion.path
        initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition}
...
export const SlashIcon = ( { stroke = ICON_BLUE, fill = ICON_BLUE, onClick }: IconProps ) => {
  return (
    <motion.svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={onClick}>
      <motion.path
        initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition}
...
export const OracleIcon = ( { stroke = ICON_BLUE, fill = ICON_BLUE, onClick, className }: IconProps ) => {
  return (
    <motion.svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={onClick} className={className}>
      <motion.path
        initial={{ pathLength: 0.001 }}
        animate={{ pathLength: 1 }}
        transition={transition}
