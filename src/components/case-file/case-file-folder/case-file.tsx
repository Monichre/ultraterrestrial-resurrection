...
import { GooeySvgFilter } from "@/components/case-file/case-file-folder/gooey-svg-filter";
...
export function CaseFiles({ caseFiles }: { caseFiles: unknown[] }) {
	console.log("🚀 ~ CaseFiles ~ caseFiles:", caseFiles);

	const [activeTab, setActiveTab] = useState(0);
	const [isGooeyEnabled, setIsGooeyEnabled] = useState(true);
	const screenSize = useScreenSize();
	const browserName = useDetectBrowser();
	const isSafari = false; //browserName.name === "Safari";
