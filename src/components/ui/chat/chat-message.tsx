...
const chatMessageAvatarVariants = cva(
	"w-8 h-8 flex items-center rounded-full justify-center ring-1 shrink-0 bg-transparent overflow-hidden",
	{
		variants: {
			type: {
				incoming: "ring-gray-200 dark:ring-gray-800",
				outgoing: "ring-gray-500/30 dark:ring-gray-400/30",
			},
		},
		defaultVariants: {
			type: "incoming",
...
const chatMessageContentVariants = cva( "flex flex-col gap-2", {
	...
	compoundVariants: [
		...
		},
		{
			variant: "bubble",
			type: "outgoing",
			className: "bg-gray-900 text-gray-50 dark:bg-gray-50 dark:text-gray-900",
		},
	],
	defaultVariants: {
		variant: "default",
