	...
	return (
		<ChatInputContext.Provider value={contextValue}>
			<div
				className={cn(
					variant === "default" &&
					"flex flex-col items-end w-full p-2 rounded-2xl border border-gray-200 bg-transparent focus-within:ring-1 focus-within:ring-gray-950 focus-within:outline-none dark:border-gray-800 dark:focus-within:ring-gray-300",
	...
	if ( loading && onStop ) {
		return (
			<Button
				onClick={onStop}
				className={cn(
					"shrink-0 rounded-full p-1.5 h-fit border border-gray-200 dark:border-zinc-600 dark:border-gray-800",
					className,
				)}
				{...props}
			>
