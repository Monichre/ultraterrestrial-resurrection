...
> **Context:** This checklist covers the AI infrastructure primarily located in [`apps/app/`](apps/app/). File paths below are workspace paths from repo root.

## 📋 REQUIRED READING ORDER (NO EXCEPTIONS)

### Phase 1: Foundation Understanding

- [ ] [**CORE_APP_AI_ARCHITECTURE_OVERVIEW.md**](apps/app/CORE_APP_AI_ARCHITECTURE_OVERVIEW.md) - System foundation and integration hierarchy
...
- [ ] Understand the [`apps/app/src/`](apps/app/src/) directory structure
- [ ] Locate key system files:
  - [ ] [`apps/app/src/app/api/disclosure/mindmap/route.ts`](apps/app/src/app/api/disclosure/mindmap/route.ts) — the ONLY working e2e AI path
  - [ ] [`apps/app/src/app/api/prometheus/chat/route.ts`](apps/app/src/app/api/prometheus/chat/route.ts) — standalone chat (separate protocol)
  - [ ] [`apps/app/src/features/mindmap/hooks/use-mindmap-agent.ts`](apps/app/src/features/mindmap/hooks/use-mindmap-agent.ts) — SSE client for disclosure agent
  - [ ] [`apps/app/src/features/mindmap/graph.tsx`](apps/app/src/features/mindmap/graph.tsx) — core React Flow canvas
  - [ ] [`apps/app/src/features/mindmap/mind-map.tsx`](apps/app/src/features/mindmap/mind-map.tsx) — canonical shell (only live shell)
  - [ ] [`apps/app/src/features/mindmap/utils/contextual-intelligence.ts`](apps/app/src/features/mindmap/utils/contextual-intelligence.ts) — foundation utility
  - [ ] [`apps/app/src/features/mindmap/store/mindmap-ui-store.ts`](apps/app/src/features/mindmap/store/mindmap-ui-store.ts) — healthy Zustand store
- [ ] Read [`apps/app/src/features/mindmap/CLAUDE.md`](apps/app/src/features/mindmap/CLAUDE.md) for dead code list and render path
