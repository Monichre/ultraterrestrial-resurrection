...
User input (PROBLEM + vague APPROACH)
  -> Phase 0 (Codex): Freeze Problem Anchor
  -> Phase 1 (Codex): Scan grounding papers -> identify technical gap -> choose the sharpest route -> write focused proposal
  -> Phase 2 (Codex/GPT-5.4): Review for fidelity, specificity, contribution quality, and frontier leverage
  -> Phase 3 (Codex): Anchor check + simplicity check -> revise method -> rewrite full proposal
