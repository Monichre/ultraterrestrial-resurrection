...
const defaultComponents = memoizeMarkdownComponents({
  ...
  a: ({ className, ...props }) => (
    <a className={cn("text-gray-900 font-medium underline underline-offset-4 dark:text-gray-50", className)} {...props} />
  ),
  ...
  th: ({ className, ...props }) => (
    <th className={cn("bg-gray-100 px-4 py-2 text-left font-bold first:rounded-tl-lg last:rounded-tr-lg [&[align=center]]:text-center [&[align=right]]:text-right dark:bg-gray-800", className)} {...props} />
  ),
  td: ({ className, ...props }) => (
