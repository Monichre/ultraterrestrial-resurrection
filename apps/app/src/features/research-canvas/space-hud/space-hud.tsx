  ...
  useEffect(() => {
    ...
    const animateWireframe = () => {
      try {
        ...
        // Animate satellites
        const satellites = document.querySelectorAll(".satellite-3d-1, .satellite-3d-2")
        ...
        // Animate nodes
        const nodes = document.querySelectorAll(".node-3d-1, .node-3d-2, .node-3d-3, .node-3d-4")
        if (nodes.length > 0) {
        ...
        console.error("Error in animateWireframe:", error)
      }
    }
