      ...
      <div className='mx-auto max-w-7xl space-y-6'>
        ...
        <div className='grid gap-6'>
          ...
          <p className='text-neutral-400'>
            Access and analyze global sighting data, research documents, and historical records.
            This system provides comprehensive tools for investigating ultraterrestrial phenomena.
          </p>
