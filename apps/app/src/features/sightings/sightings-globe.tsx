...
import {useTimeSeriesAnimation} from '@/features/sightings/useTimeSeriesAnimation'
...
export const SightingsGlobe = ({geoJSONSightings}: SightingsGlobeProps) => {
  ...
  const buildVisualizationLayers = useCallback(() => {
    ...
    const validFeatures = (filteredSightings.features as any[]).filter(
      (d) => d && d.geometry && d.geometry.type === 'Point' && Array.isArray(d.geometry.coordinates)
    ) as any[]
        ...
        <div className='mb-3'>
          ...
          <div className='flex flex-wrap gap-2'>
            <button
              type='button'
              onClick={() =>
                setTimeRange([new Date(1947, 0, 1).getTime(), new Date(1970, 0, 1).getTime()])
              }
            ...
            <button
              type='button'
              onClick={() =>
                setTimeRange([new Date(1970, 0, 1).getTime(), new Date(1990, 0, 1).getTime()])
              }
              className='rounded bg-gray-800 px-2 py-1 text-xs hover:bg-gray-700'>
              1970–1990
            </button>
            <button
              type='button'
              onClick={() =>
                setTimeRange([new Date(1990, 0, 1).getTime(), new Date(2010, 0, 1).getTime()])
              }
              className='rounded bg-gray-800 px-2 py-1 text-xs hover:bg-gray-700'>
              1990–2010
            </button>
