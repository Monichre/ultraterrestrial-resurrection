                ...
                >
                  <AnimatePresence mode="popLayout">
                    {animationState !== "complete" ? (
                      ...
                      >
                        <div className="flex flex-1 items-start gap-4 text-neutral-300 text-sm overflow-y-auto max-h-[200px]">
                        ...
                        >
                          ...
                          <button
                            ...
                            className="flex items-center justify-center bg-transparent border-none cursor-pointer text-neutral-400 hover:text-white transition-colors disabled:opacity-50"
                          >
                            <ArrowUp className="size-4" />
                          </button>
                        </form>
