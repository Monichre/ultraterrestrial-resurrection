...
export const TYPER_ITEMS = [
  {
    ...
    icon: Radiation,
    name: 'Nuclear Shadow',
    command: 'Open tour: The Nuclear Shadow — Architecture of Secrecy',
    description: 'Act I evidence graph: Manhattan secrecy machine → Roswell',
    href: '/tours/nuclear-shadow',
  },
  {
    id: 2,
    icon: MapPin,
    name: 'Roswell',
    command: 'Start guided tour: Roswell - Where It All Began',
    description: 'The 1947 incident that started it all',
  },
  {
    id: 3,
    icon: Rocket,
    name: 'Mars Origins',
    command: 'Start guided tour: Mars Origins Theory',
    description: 'Extraterrestrial life hypothesis',
  },
  {
    id: 4,
    icon: Landmark,
    name: 'Ancient Archaeology',
    command: 'Start guided tour: Ancient Archaeology',
    description: 'Evidence from ancient civilizations',
  },
] as const
