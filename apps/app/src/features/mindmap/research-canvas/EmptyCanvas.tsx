      ...
      <div className='w-full flex-1 flex flex-col items-center justify-center px-4'>
        {isLoading ? (
          <div className='text-center max-w-2xl'>
            ...
            <p className='text-sm text-zinc-500'>Analyzing your query and searching sources</p>
          </div>
        ) : hasError ? (
          <div className='text-center max-w-2xl'>
            ...
            <p className='text-sm text-zinc-500'>
              The investigation could not continue. Reframe the research question and try again.
            </p>
          </div>
        ) : (
          <div className='text-center max-w-2xl space-y-4'>
            <h1 className='text-4xl font-light tracking-tight text-white'>Research Canvas</h1>
            <p className='text-sm text-zinc-400 leading-relaxed max-w-sm mx-auto'>
              Assemble records to begin an investigation. Select a topic card to follow a guided
              trace, or enter your own research question.
            </p>
