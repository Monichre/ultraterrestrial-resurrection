...
export function DynamicToolbar() {
  ...
  return (
    <div className='bg-neutral-950 bg-gradient-to-b from-black/90 border border-zinc-200 dark:border-zinc-800 rounded-xl p-2 shadow-lg w-fit relative'>
      <div className='absolute -top-8 left-1/2 -translate-x-1/2 text-white font-medium rounded-md text-xs'>
        <AnimatePresence>
          {clickedButton && (
            <motion.div
          ...
          <AnimatePresence mode='wait'>
            {isSearchExpanded ? (
              <motion.div
                ...
                <motion.div
                  ...
                  <Input
                    ...
                    className='w-[200px] h-7 px-0 bg-transparent border-none text-zinc-100 placeholder:text-zinc-400'
              ...
              <motion.button
                ...
                className='h-10 w-10 rounded-xl hover:bg-zinc-800 transition-colors flex items-center justify-center'>
                <Search
                  className={cn(
                    iconClass,
                    isSearchFocused
