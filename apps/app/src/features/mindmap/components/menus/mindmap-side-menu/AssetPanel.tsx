import { List, SlidersHorizontal, BoxSelect } from "lucide-react"
import { Input } from "@/components/ui/input"
import { Button } from "@/components/ui/button"
import { Tabs, TabsList, TabsTrigger } from "@/components/ui/tabs"
import { MagnifyingGlassIcon, Cross2Icon, PlusIcon } from "@radix-ui/react-icons"

export function AssetPanel() {
  return (
    <div className="w-[425px] h-auto flex flex-col bg-neutral-800/90 text-white shadow-lg backdrop-blur-md border border-gray-200 border-white/5 rounded-2xl dark:border-gray-800">
      <header className="border-b border-b-[#292f35] top-0 z-10 sticky p-2">
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="text-[#8c8c8c] hover:bg-white/10 hover:text-white size-8 shrink-0"
          >
            <Cross2Icon size={16} strokeWidth={2} />
          </Button>
        </div>
