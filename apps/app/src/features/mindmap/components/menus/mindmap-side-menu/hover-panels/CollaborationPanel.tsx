...
import { Users, Share2, MessageCircle, Clock, Crown, Eye, Edit, Link } from "lucide-react"
...
const RECENT_ACTIVITY: Activity[] = [
  ...
  },
  {
    id: "3",
    user: "Sarah Chen",
    action: "shared the project with team",
      ...
      <div className="p-3 space-y-4 overflow-y-auto max-h-96">
        ...
        <div className="space-y-2">
          ...
          <Button size="sm" className="w-full h-8">
            <PlusIcon size={14} className="mr-1" strokeWidth={2} />
            Send Invite
          </Button>
        </div>
