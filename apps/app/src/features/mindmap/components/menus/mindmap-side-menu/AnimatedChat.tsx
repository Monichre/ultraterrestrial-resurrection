    ...
    <div className="flex flex-col items-center gap-4">
      ...
      >
        <form onSubmit={handleSubmit} className="relative">
          <motion.div
            className="relative flex items-center bg-neutral-900/80 backdrop-blur-sm border border-gray-200 border-neutral-800 rounded-2xl overflow-hidden shadow-[0_0_0_1px_rgba(255,255,255,0.03)] dark:border-gray-800"
            animate={{
