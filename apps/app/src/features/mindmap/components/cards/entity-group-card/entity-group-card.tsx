...
export const EntityGroupCard: React.FC<EntityGroupCardProps> = ({card}) => {
  ...
  const {getIntersectingNodes, useNodesData, toggleLocationVisualization, screenToFlowPosition} =
    useMindMap()
  const [ref, {x: parentX, y: parentY, width, height, top, right, bottom, left}]: any = useMeasure()
      ...
      <div
        ...
        <CardTop>
          ...
          <div className='text-bg-emerald-green-300 cursor-pointer text-xs'>
            <Button variant='ghost' className='text-bg-emerald-green-300 m-2' onClick={toggleStack}>
        ...
        <CardBottom>
          ...
          <div className='cursor-pointer  w-8 h-8'>
            <Button variant='ghost' className='ml-auto' onClick={toggleLocationVisualization}>
