...
export { default as Emoji } from '@tiptap-pro/extension-emoji'
...
export { default as TableOfContents } from '@tiptap-pro/extension-table-of-contents'
...
export { default as FileHandler } from '@tiptap-pro/extension-file-handler'
