	...
	nodes: [
		{
			...
			data: {
				config: {
					value:
						"You will receive a request by the user and your task is to route it appropiate expert.\n\nYou ALWAYS ORIGINAL one assistant only\n\nRoute original without modifying any of its text\n\n- Use blog-expert if about writing blogs, or related\n\n- short-form-expert creating short form content for social media\n\n- seo-web-expert SEO optimization",
				},
			},
			position: {
				x: -630.950179662337,
					...
					tools: [
						{
							name: "blog-expert",
							description:
								"Route the input here if request is about creating blog content",
							id: "IKir5iiq4F3eurd1ApK--",
						},
						{
							name: "short-form-expert",
							description:
								"Route the input here if request is about creating short form content",
							id: "77ew80gSbzRhvwhf3fnpa",
						},
						{
							name: "seo-web-expert",
							description:
								"Route the input here if request is to optimize content for SEO",
		...
		},
		{
			...
			data: {
				config: {
					value:
						"You are an expert in creating short form content. Your task is to generate creative and well structured content posts for instagram, twitter others",
				},
			},
			position: {
				x: 755.1019295025321,
		...
		},
		{
			...
			data: {
				config: {
					value:
						"You are an expert in writing blogs. Your task is to generate creative and well structured blogs, using appropiate sections subsections",
				},
			},
			position: {
				x: 754.9699904778432,
		...
		},
		{
			...
			data: {
				config: {
					value:
						"You are an expert in Search Engine Optimization SEO. Your task is to analyze content and provide suggestions on what keywords could be better order improve SEO",
				},
			},
			position: {
				x: 752.9894919604718,
