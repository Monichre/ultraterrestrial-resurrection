...
export function RealtimeGlobe({
  ...
  const globePoints = useMemo(() => {
    ...
    const filteredSightings = showRecentOnly
      ? sightings.filter((s: any) => s._isRecent)
      : sightings
            ...
            <Card className="bg-black/95 backdrop-blur border-white/20 p-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-4 text-sm text-white/70">
                    <div className="flex items-center space-x-1">
                      ...
                      <span>
                        {selectedSighting.location?.city || 'Unknown location'}
                      </span>
                    </div>
                    <div className="flex items-center space-x-1">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex space-x-1">
                  ...
                  {(selectedSighting as any)._isRecent && !(selectedSighting as any)._isVeryRecent && (
