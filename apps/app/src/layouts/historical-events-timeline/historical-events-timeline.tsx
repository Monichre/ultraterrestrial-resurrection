    ...
    <>
      <div className='fixed top-0 left-0 right-0 bottom-0 bg-black h-full w-full z-0'>
        ...
        <div className='absolute top-0 left-0 z-10 h-[100vh] w-[100vw]'>
          ...
          {viewMode === 'worldmap' && (
            <WorldMap markers={locations} activeLocation={activeLocation} />
          )}
          ...
          {viewMode === 'sci-fi' && (
            <SciFiGlobe markers={locations} activeLocation={activeLocation} arcsData={arcsData} />
          )}
        </div>
      </div>
      ...
      <div className='fixed top-0 left-0 w-screen h-screen z-30'>
        ...
        <div className='absolute top-4 right-4 flex gap-2 z-50'>
          <button
            ...
            className={`px-3 py-1 font-monumentMono rounded ${
              viewMode === 'worldmap'
          ...
          <button
            ...
            className={`px-3 py-1 font-monumentMono rounded ${
              viewMode === 'globe' ? 'bg-cyan-500 text-black' : 'bg-black bg-opacity-70 text-white'
            }`}>
            Globe
          </button>
          <button
            ...
            className={`px-3 py-1 font-monumentMono rounded ${
              viewMode === 'sci-fi' ? 'bg-cyan-500 text-black' : 'bg-black bg-opacity-70 text-white'
            }`}>
            Sci-Fi View
          </button>
        </div>
