...
export const StateOfDisclosureProvider: React.FC<StateOfDisclosureProviderProps> = ({
  ...
  const {records, connections, graphData: mindMapIntialGraphState} = stateOfDisclosure

  return (
    <StateOfDisclosureContext.Provider value={{records, connections, mindMapIntialGraphState}}>
      {children}
