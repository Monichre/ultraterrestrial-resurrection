...
export const tavilyTools = (
  ...
  const tools: Partial<Record<TavilyTools, Tool>> = {
    search: tool({
      description:
        "'Perform a comprehensive web search and get detailed results including optional images AI-generated answers'",
      parameters: z.object({
        query: z
          .string()
        ...
        searchDepth: z
          ...
          .optional()
          .describe(
            "'Depth of search - basic is faster, advanced more thorough'"
          ),
        topic: z
          .enum(["'general'", "'news'"])
          .optional()
          .describe(
            "'Category of search - general for broad searches, news recent events'"
          ),
        days: z
          .number()
          .optional()
          .describe(
            "'Number of days back to search (only works with news topic, defaults 3)'"
          ),
        timeRange: z
        ...
        includeAnswer: z
          ...
          .optional()
          .describe(
            "'Include AI-generated answer to query - basic is quick, advanced detailed'"
          ),
        includeRawContent: z
          .boolean()
          .optional()
    ...
    searchContext: tool({
      description:
        "'Search the web and get content sources within a specified token limit, optimized for context retrieval'",
      parameters: z.object({
        query: z
          .string()
          .describe("'The search query to find information about'"),
