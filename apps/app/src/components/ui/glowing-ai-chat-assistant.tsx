    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button 
        ...
        style={{
          ...
          boxShadow: "'0 0 20px rgba(139, 92, 246, 0.7), 40px rgba(124, 58, 237, 0.5), 60px rgba(109, 40, 217, 0.3)'",
      ...
      {isChatOpen && (
        ...
        >
          <div className="relative flex flex-col rounded-3xl bg-gradient-to-br from-zinc-800/80 to-zinc-900/90 border border-gray-200 border-zinc-500/50 shadow-2xl backdrop-blur-3xl overflow-hidden dark:border-gray-800">
            ...
            <div className="flex items-center justify-between px-6 pt-4 pb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-1 text-xs font-medium bg-red-500/10 text-red-400 border border-gray-200 border-red-500/20 rounded-2xl dark:border-gray-800">
                  Pro
                </span>
                <button 
            ...
            <div className="px-4 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  {/* Attachment Group */}
                  <div className="flex items-center gap-1.5 p-1 bg-zinc-800/40 rounded-xl border border-gray-200 border-zinc-700/50 dark:border-gray-800">
                    {/* File Upload */}
                    ...
                    <button className="group relative p-2.5 bg-transparent border-none rounded-lg cursor-pointer transition-all duration-300 text-zinc-500 hover:text-purple-400 hover:bg-zinc-800/80 hover:scale-105 hover:-rotate-6 transform">
                      <svg className="w-4 h-4 transition-all duration-300 group-hover:scale-125 group-hover:rotate-12" viewBox="0 24" fill="currentColor">
                        <path d="M15.852 8.981h-4.588V0h4.588c2.476 0 4.49 2.014 4.49s-2.014 4.491-4.49 4.491zM12.735 7.51h3.117c1.665 3.019-1.355 3.019-3.019s-1.354-3.019-3.019-3.019h-3.117V7.51zm0 1.471H8.148c-2.476 0-4.49-2.015-4.49-4.49S5.672 8.148 0h4.588v8.981zm-4.587-7.51c-1.665 0-3.019 1.355-3.019 3.019s1.354 3.02 3.019 3.02h3.117V1.471H8.148zm4.587 15.019H8.148c-2.476 0-4.49-2.014-4.49-4.49s2.014-4.49 4.49-4.49h4.588v8.98zM8.148 8.981c-1.665 3.019s1.355 3.019h3.117v-6.038H8.148zm7.704 0c-2.476 0-4.49 2.015-4.49 4.49s2.014 4.49-2.015 4.49-4.49-2.014-4.49-4.49-4.49zm0 7.509c-1.665 0-3.019-1.355-3.019-3.019s1.355-3.019 3.019-3.019 1.354 3.019-1.354 3.019zM8.148 24c-2.476 0-4.49-2.015-4.49-4.49s2.014-4.49 4.49-4.49h4.588V24H8.148zm3.117-1.471V16.49H8.148c-1.665 3.02h3.117z"></path>
                      </svg>
                      <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 px-3 py-2 bg-zinc-900/95 text-zinc-200 text-xs rounded-lg whitespace-nowrap opacity-0 transition-all duration-300 pointer-events-none group-hover:opacity-100 group-hover:-translate-y-1 shadow-lg border border-gray-200 border-zinc-700/50 backdrop-blur-sm dark:border-gray-800">
                        Design file
                        <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-zinc-900/95"></div>
                  ...
                  {/* Voice Button */}
                  <button className="group relative p-2.5 bg-transparent border border-gray-200 border-zinc-700/30 rounded-lg cursor-pointer transition-all duration-300 text-zinc-500 hover:text-red-400 hover:bg-zinc-800/80 hover:scale-110 hover:rotate-2 transform hover:border-red-500/30 dark:border-gray-800">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button 
                    ...
                    style={{
                      boxShadow: "'0 10px 15px -3px rgba(0, 0, 0.1), 0 rgba(239, 68, 0.4)'",
                      animation: "'none'"
                    }}
                    onMouseEnter={(e) => {
              ...
              <div className="flex items-center justify-between mt-3 pt-3 border-t border-zinc-800/50 text-xs text-zinc-500 gap-6">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Press <kbd className="px-1.5 py-1 bg-zinc-800 border border-gray-200 border-zinc-600 rounded text-zinc-400 font-mono text-xs shadow-sm dark:border-gray-800">Shift + Enter</kbd> for new line
                  </span>
                </div>
            ...
            <div 
              ...
              style={{ 
                background: "'linear-gradient(135deg, rgba(239, 68, 0.05), transparent, rgba(147, 51, 234, 0.05))'" 
              }}
            ></div>
          </div>
        </div>
