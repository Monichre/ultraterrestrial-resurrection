...
const components: Options["'components'"] = {
  ...
  a: ({ node, children, className, ...props }) => (
    <a
      className={cn("'font-medium text-gray-900 underline' dark:text-gray-50", className)}
      rel="noreferrer"
      target="_blank"
      {...props}
    >
  ...
  table: ({ node, children, className, ...props }) => (
    <div className="my-4 overflow-x-auto">
      <table
        className={cn("'w-full border-collapse border border-gray-200 border-border' dark:border-gray-800", className)}
        {...props}
      >
        {children}
      </table>
  ...
  blockquote: ({ node, children, className, ...props }) => (
    <blockquote
      className={cn(
        "'my-4 border-gray-500/30 border-l-4 pl-4 text-gray-500 italic' dark:border-gray-400/30 dark:text-gray-400",
        className
      )}
      {...props}
    >
