    ...
    return (
      ...
      >
        {badgeText && (
          <Badge
            variant="outline"
            className="bg-gray-100 border-gray-200 text-gray-500 dark:bg-gray-800 dark:border-gray-800 dark:text-gray-400"
          >
            {badgeText}
          </Badge>
        )}
        ...
        <MotionConfig transition={transition}>
          <div
            className="w-full rounded-2xl shadow-[0_0_0_1px_rgba(0,0,0,0.08),0px_2px_2px_rgba(0,0,0,0.04),0px_8px_16px_-4px_rgba(0,0,0,0.04)] dark:shadow-[0_0_0_1px_rgba(255,252,240,0.08),0px_2px_2px_rgba(0,0,0,0.2),0px_8px_16px_-4px_rgba(0,0,0,0.3)] bg-white overflow-hidden dark:bg-gray-950"
            ref={ref}
          >
                  ...
                  <div className="flex items-center p-[1px] w-max min-w-full">
                    {navigationButtons.map((button, index) => (
                      <button
                        ...
                        className={cn(
                          "text-sm text-gray-500 transition-colors py-3 px-3 sm:py-4 sm:px-4 whitespace-nowrap shrink-0 flex items-center gap-2 min-h-[44px] sm:min-h-0 dark:text-gray-400",
                          button.isActive
                            ? "text-gray-950 font-medium bg-gray-100/50 dark:text-gray-50 dark:bg-gray-800/50"
                            : "hover:bg-gray-100/60 active:bg-gray-100/70 dark:hover:bg-gray-800/60 dark:active:bg-gray-800/70"
                        )}
                      >
                        ...
                        <span className="text-xs sm:text-sm font-medium text-gray-950 dark:text-gray-50">
                          {button.label}
                        </span>
                      </button>
                    ))}
...
>(({ className, orientation = "vertical", ...props }, ref) => {
  ...
  return (
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      ...
      className={cn(
        "hover:bg-gray-100 dark:hover:bg-gray-100/50 data-[state=visible]:fade-in-0 data-[state=hidden]:fade-out-0 data-[state=visible]:animate-in data-[state=hidden]:animate-out flex touch-none p-px transition-[colors] duration-150 select-none dark:hover:bg-gray-800 dark:dark:hover:bg-gray-800/50",
    ...
    >
      <ScrollAreaPrimitive.ScrollAreaThumb
        ...
        className={cn(
          "bg-gray-200 relative flex-1 origin-center rounded-full transition-[scale] dark:bg-gray-800",
