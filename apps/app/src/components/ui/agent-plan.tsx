...
export default function Plan() {
  ...
  return (
    <div className="bg-white text-gray-950 h-full overflow-auto p-2 dark:bg-gray-950 dark:text-gray-50">
      <motion.div 
        className="bg-white border-gray-200 rounded-lg border shadow overflow-hidden dark:bg-gray-950 dark:border-gray-800"
                    ...
                    >
                        ...
                        <AnimatePresence mode="wait">
                          ...
                          >
                            {task.status === "completed" ? (
                              ...
                              <DotFilledIcon className="text-gray-500 h-4.5 w-4.5 dark:text-gray-400" />
                            )}
                          </motion.div>
                        </AnimatePresence>
                      </motion.div>
                      ...
                      >
                        <div className="mr-2 flex-1 truncate">
                          <span
                            className={`${isCompleted ? "text-gray-500 line-through dark:text-gray-400" : ""}`}
                          >
                            {task.title}
                          </span>
                        </div>
                            ...
                            <div className="flex items-center mr-2">
                              <div className="flex flex-wrap gap-1">
                                {task.dependencies.map((dep, idx) => (
                                  <motion.span
                                    key={idx}
                                    className="bg-gray-100/40 text-gray-900 rounded px-1.5 py-0.5 text-[10px] font-medium shadow-sm dark:bg-gray-800/40 dark:text-gray-50"
                    ...
                    <AnimatePresence mode="wait">
                      {isExpanded && task.subtasks.length > 0 && (
                        ...
                        >
                          ...
                          <div className="absolute top-0 bottom-0 left-[20px] border-l-2 border-dashed border-gray-500/30 dark:border-gray-400/30" />
                          <ul className="border-gray-100 mt-1 mr-2 mb-1.5 ml-3 space-y-0.5 dark:border-gray-800">
                              ...
                              return (
                                ...
                                >
                                  ...
                                  >
                                      ...
                                      <AnimatePresence mode="wait">
                                        ...
                                        >
                                          {subtask.status === "completed" ? (
                                            ...
                                            <DotFilledIcon className="text-gray-500 h-3.5 w-3.5 dark:text-gray-400" />
                                          )}
                                        </motion.div>
                                      </AnimatePresence>
                                    </motion.div>
                                    ...
                                    <span
                                      className={`cursor-pointer text-sm ${subtask.status === "completed" ? "text-gray-500 line-through dark:text-gray-400" : ""}`}
                                    >
                                      {subtask.title}
                                    </span>
                                  </motion.div>
                                  ...
                                  <AnimatePresence mode="wait">
                                    {isSubtaskExpanded && (
                                      <motion.div 
                                        className="text-gray-500 border-gray-950/20 mt-1 ml-1.5 border-l border-dashed pl-5 text-xs overflow-hidden dark:text-gray-400 dark:border-gray-50/20"
