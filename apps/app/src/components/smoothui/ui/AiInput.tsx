  ...
  return (
    ...
    >
      <motion.div
        ...
        ref={rootRef}
        className={cx(
          "bg-white relative bottom-8 z-3 flex flex-col items-center overflow-hidden border border-gray-200 max-sm:bottom-5 dark:bg-gray-950 dark:border-gray-800"
        )}
        initial={false}
        animate={{
        ...
        {showFeedback && (
          ...
          >
            <div className="flex justify-between py-1">
              <p className="text-gray-950 z-2 ml-[38px] flex items-center gap-[6px] select-none dark:text-gray-50">
                AI Input
              </p>
              <button
                type="submit"
                ref={submitRef}
                className="text-gray-950 right-4 mt-1 flex -translate-y-[3px] cursor-pointer items-center justify-center gap-1 rounded-[12px] bg-transparent pr-1 text-center select-none dark:text-gray-50"
              >
                <Kbd>⌘</Kbd>
            ...
            <textarea
              ...
              name="message"
              className="bg-gray-900 h-full w-full resize-none scroll-py-2 rounded-md p-4 outline-0 dark:bg-gray-50"
              required
              onKeyDown={onKeyDown}
              spellCheck={false}
            />
...
function Kbd({
  ...
  return (
    <kbd
      className={cx(
        "bg-gray-900 text-gray-950 flex h-6 w-fit items-center justify-center rounded-sm border border-gray-200 px-[6px] font-sans dark:bg-gray-50 dark:text-gray-50 dark:border-gray-800",
        className
      )}
    >
      {children}
