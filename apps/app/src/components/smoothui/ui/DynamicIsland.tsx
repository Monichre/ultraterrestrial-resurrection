...
const DefaultRing = () => {
  return (
    <div className="text-gray-950 flex w-64 items-center gap-3 overflow-hidden px-4 py-2 dark:text-gray-50">
...
const MusicPlayer = () => {
  ...
  return (
    <div className="text-gray-950 flex w-72 items-center gap-3 overflow-hidden px-4 py-2 dark:text-gray-50">
  ...
  return (
    <div className={`h-[200px] ${className}`}>
      <div className="relative flex h-full w-full flex-col justify-center">
        ...
        <div className="bg-white absolute bottom-2 left-1/2 z-10 flex -translate-x-1/2 justify-center gap-1 rounded-full border border-gray-200 p-1 dark:bg-gray-950 dark:border-gray-800">
          {[
            ...
            <button
              type="button"
              className="bg-gray-900 flex size-8 cursor-pointer items-center justify-center rounded-full border border-gray-200 px-2 dark:bg-gray-50 dark:border-gray-800"
              onClick={() => {
                if (view !== key) {
