...
const GalleryFlow = React.forwardRef<HTMLDivElement, GalleryFlowProps>(
  (
    ...
    }, [autoPlay, currentIndex, images.length, interval, isHovered, isDragging, loop])
            ...
            <>
              ...
              <button
                ...
                className={cn(
                  ...
                  !loop && currentIndex === images.length - 1 && 'cursor-not-allowed opacity-50'
                )}
            ...
            {images.map((_, index) => (
              <button
                ...
                className={cn(
                  ...
                  index === currentIndex ? 'scale-125 bg-primary' : 'bg-gray-300 hover:bg-gray-400'
                )}
              />
            ))}
          </div>
