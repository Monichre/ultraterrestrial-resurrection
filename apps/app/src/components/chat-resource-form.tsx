...
import { ResearchDepth, ResearchCategory } from "@/services/resource-scrape/firecrawl";
    ...
    <div className="w-full space-y-4">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value={ResearchDepth.SURFACE}>Surface (Quick Scan)</SelectItem>
                            <SelectItem value={ResearchDepth.MODERATE}>Moderate (Standard Analysis)</SelectItem>
                            <SelectItem value={ResearchDepth.DEEP}>Deep (Thorough Analysis)</SelectItem>
                            <SelectItem value={ResearchDepth.COMPREHENSIVE}>Comprehensive (Exhaustive Analysis)</SelectItem>
                          </SelectContent>
                        </Select>
                        <FormDescription>
          ...
          >
            {isProcessing ? 'Processing...' : resourceType === 'url' ? 'Analyze Website' : 'Process Document'}
          </Button>
        </form>
      </Form>
    </div>
