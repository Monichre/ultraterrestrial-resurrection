  ...
  return (
    <div className='relative w-full h-screen bg-zinc-50 overflow-hidden'>
      ...
      <div className='relative z-10 p-8'>
        ...
        {/* Document Footer */}
        <div className='absolute bottom-4 left-8 right-8 flex justify-between items-center border-t border-zinc-300 pt-4'>
          <div className='text-xs text-zinc-500'>
            CLASSIFICATION: RESTRICTED | DISTRIBUTION: LIMITED
          </div>
          <div className='text-xs text-zinc-500'>PAGE 1 OF 1 | UAP-2024-001A</div>
        </div>
      </div>
    </div>
  )
