          ...
          <div className="flex gap-8">
            ...
            <div className="flex-1">
              ...
              <div className="bg-gray-100 p-4 border-2 border-gray-600 shadow-lg transform -rotate-1">
                <div className="text-xs text-black mb-2 opacity-75">WASHINGTON POST JULY 26 1947</div>
                <div className="mb-4">
                ...
                <div className="text-xs text-black leading-tight space-y-2">
                  <p className="mb-2">
                    <span className="bg-red-200 px-1">1.</span> "National Intelligence" was defined to<br/>
                    to include nuclear weapons—related<br/>
                    information.
                  </p>
                  <p className="mb-2">
                    In its definitions (at what is now 50 U.S.C. §<br/>
                    § 3009(3)(BILL)), "national intelligence" covers<br/>
                    weapons of mass destruction," explicitly<br/>
                    re—the development, proliferation, or use of<br/>
                    of weapons of mass-technology matters. o
                  </p>
                  <p className="mb-2">
                    <span className="font-bold">Probe elecibensment</span><br/>
                    <span className="font-bold">ranergence amucli ∼</span><br/>
            ...
            <div className="flex-1">
              ...
              <div className="text-right mb-6">
                <div className="inline-block relative">
                  ...
                  <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 40">
                    <ellipse cx="50" cy="20" rx="45" ry="18" fill="none" stroke="black" strokeWidth="2"/>
                  </svg>
                </div>
              </div>
              {/* Document Content */}
              <div className="text-sm text-black leading-relaxed space-y-4">
                <p className="mb-4">
                  The National Security Act of 1947<br/>
                  established the Central Intelligence Agency
                </p>
                <div className="mb-4">
                  <p className="mb-2">
                    <span className="bg-red-200 px-1 rounded">1.</span> "National Intelligence" was defined<br/>
                    to include nuclear weapons—related<br/>
                    information.
                  </p>
                  <p className="mb-4">
                    ...
                    § 3009(3)(BILL)), "national intelligence" covers<br/>
                    weapons of mass destruction," explicitly<br/>
                    re—the development, proliferation, or use<br/>
                    of weapons of mass-technology matters. o
                  </p>
                </div>
                <p className="mb-4">
                  <span className="font-bold">2. Coordination of atomic-energy resources</span><br/>
                  resources under the NSC.
                </p>
                <p className="mb-4">
                  Title i established the National Security<br/>
                  board—an NSC Advisory body charged with<br/>
                  coordinating military, industrial, and civilian<br/>
                  mobilization with the field of research and
                </p>
                <p className="mb-4">
                  <span className="font-bold">3. Legislative carve-out for the</span><br/>
