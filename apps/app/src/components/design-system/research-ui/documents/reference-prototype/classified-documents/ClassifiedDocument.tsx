                ...
                if (section.type === 'stamp') {
                  return (
                    <div key={sectionIndex} className='flex justify-center mt-8'>
                      <div
                        className={`border-4 border-gray-600 px-8 py-4 transform rotate-${section.data.rotation}`}>
                        <span className='text-3xl font-bold tracking-widest text-gray-700'>
                          {section.data.text}
                        </span>
                      </div>
                    </div>
                ...
                if (section.type === 'text') {
                  return (
                    <div key={sectionIndex}>
                      {section.data.sections?.map((textSection, textIndex) => (
