...
const typographyVariants = cva('transition-all duration-200', {
  variants: {
    variant: {
      ...
      'stamp': 'font-anton text-xl tracking-widest uppercase font-black transform rotate-[3deg] classified-stamp',
...
const Typography = React.forwardRef<HTMLElement, TypographyProps>(
  ({ className, variant, size, weight, align, transform, color, as, glitch, rotation, dataText, children, style, ...props }, ref) => {
...
export const Heading = React.forwardRef<HTMLHeadingElement, TypographyProps>(
  (props, ref) => <Typography as="h1" variant="heading-main" {...props} ref={ref} />
)
Heading.displayName = 'Heading'

export const SubHeading = React.forwardRef<HTMLHeadingElement, TypographyProps>(
  (props, ref) => <Typography as="h2" variant="h3" {...props} ref={ref} />
)
SubHeading.displayName = 'SubHeading'

export const DataLabel = React.forwardRef<HTMLSpanElement, TypographyProps>(
  (props, ref) => <Typography as="span" variant="data-label" {...props} ref={ref} />
)
DataLabel.displayName = 'DataLabel'

export const DataValue = React.forwardRef<HTMLSpanElement, TypographyProps>(
  (props, ref) => <Typography as="span" variant="data-value" {...props} ref={ref} />
)
DataValue.displayName = 'DataValue'

export const Code = React.forwardRef<HTMLElement, TypographyProps>(
  (props, ref) => <Typography as="code" variant="code" {...props} ref={ref} />
)
Code.displayName = 'Code'

// Research/Archival Interface Components
export const TypewriterText = React.forwardRef<HTMLElement, TypographyProps>(
  (props, ref) => <Typography variant="typewriter" {...props} ref={ref} />
)
TypewriterText.displayName = 'TypewriterText'

export const HandwrittenNote = React.forwardRef<HTMLSpanElement, TypographyProps>(
  (props, ref) => <Typography as="span" variant="handwritten" {...props} ref={ref} />
)
HandwrittenNote.displayName = 'HandwrittenNote'

export const ClassifiedStamp = React.forwardRef<HTMLSpanElement, TypographyProps>(
  (props, ref) => <Typography as="span" variant="stamp" color="classified-red" {...props} ref={ref} />
)
...
export const GlitchText = React.forwardRef<HTMLElement, TypographyProps>(
  ({ children, dataText, ...props }, ref) => (
    <Typography variant="glitch" glitch dataText={dataText || String(children)} {...props} ref={ref}>
      {children}
    </Typography>
  )
)
...
export const RedactedText = React.forwardRef<HTMLElement, TypographyProps>(
  (props, ref) => <Typography variant="redacted" {...props} ref={ref} />
)
