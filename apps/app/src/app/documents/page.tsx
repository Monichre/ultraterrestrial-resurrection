...
import {DocumentLibrary} from '@/components/design-system/research-ui/documents/document-library'
  ...
  return (
    <div className='container mx-auto py-8'>
      <div className='mb-8'>
        ...
        <p className='text-gray-600'>Browse and view UFO/UAP research documents</p>
      </div>
