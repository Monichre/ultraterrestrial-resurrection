...
import "../../styles/research-base.css"
  ...
  return (
    <main className="research-base min-h-screen p-4">
      <div className="container mx-auto">
        <h1 className="text-2xl font-bold mb-6 text-neutral-300 font-mono">ULTRATERRESTRIAL RESEARCH PLATFORM</h1>
          ...
          <div className="w-full bg-black border border-neutral-800 rounded-sm mb-4 flex">
            <button
              ...
              className={`font-mono text-xs px-4 py-2 ${
                activeTab === "hud" ? "bg-neutral-900 text-[#adf0dd]" : "text-neutral-500 hover:text-neutral-300"
              }`}
            >
              HEADS-UP DISPLAY
            </button>
            <button
              ...
              className={`font-mono text-xs px-4 py-2 ${
                activeTab === "document" ? "bg-neutral-900 text-[#adf0dd]" : "text-neutral-500 hover:text-neutral-300"
              }`}
            >
