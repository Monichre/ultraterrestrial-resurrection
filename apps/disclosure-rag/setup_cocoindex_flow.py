...
DATABASE_URL = os.getenv("COCOINDEX_DATABASE_URL", "postgresql://cocoindex:cocoindex@localhost:5432/cocoindex")
...
def ufo_research_flow(flow_builder: cocoindex.FlowBuilder, data_scope: cocoindex.DataScope):
    ...
    knowledge_base_path = os.getenv("KNOWLEDGE_BASE_DIRECTORY_PATH", "data/documents")
