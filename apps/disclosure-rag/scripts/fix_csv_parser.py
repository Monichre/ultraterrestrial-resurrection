...
def extract_sample_documents(limit: int = 5) -> List[Dict[str, Any]]:
    ...
    csv_path = working_dir / "/data/queue/documents.csv"
    ...
    sample_data = [
        {
            ...
            # 384D
            'embedding': '[-0.024452312, 0.014676657, -0.0052204896]' + ', 0.0' * 381,
        ...
        },
        {
            ...
            # 384D
            'embedding': '[0.008815529, -0.0015383199, 0.0015848331]' + ', 0.0' * 381,
        ...
        },
        {
            ...
            # 384D
            'embedding': '[-0.029566962, -0.010946495, -0.027954219]' + ', 0.0' * 381,
