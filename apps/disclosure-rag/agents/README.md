...
- **EntityExtractionAgent** (`entity_extraction_agent.py`): Extracts topics, personnel, events, organizations, locations, artifacts, sightings, and relationships as structured output. Includes `AIEntityExtractor`, `XataSearchTool` for DB lookups, and embedding generation utilities.
