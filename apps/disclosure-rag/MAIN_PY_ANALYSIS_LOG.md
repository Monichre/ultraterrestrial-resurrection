...
**File Management:**
- Line 239-262: Move processed files from processing_queue to case_files
...
- Automatic case_files directory creation
- Processing queue to case_files file movement
