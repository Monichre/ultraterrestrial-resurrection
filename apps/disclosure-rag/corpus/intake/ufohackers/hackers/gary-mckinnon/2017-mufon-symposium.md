> For the complete documentation index, see [llms.txt](https://www.ufohackers.org/hackers/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://www.ufohackers.org/hackers/gary-mckinnon/2017-mufon-symposium.md).

# 2017 MUFON Symposium

*Since the book with these proceedings is no longer available via MUFON, I have made this transcript available online for posterity. The talk video itself is available on* [*Gary's YouTube*](https://youtu.be/LTemN5XTdec)*.*
