> For the complete documentation index, see [llms.txt](https://www.ufohackers.org/hackers/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://www.ufohackers.org/hackers/gary-mckinnon/mckinnon-overview.md).

# McKinnon Overview

![](/files/SAZsurM7a0rM0W0WJ7H6)
...
* **2006** interview with Jerry Pippin:&#x20;

{% file src="/files/T0TGb1sbH4DYBIYWBPsj" %}
...
* **2009** NPR Radio Report on Gary:

{% file src="/files/4UV3mJFRhxG4XEjawP2h" %}
...
## A Note on the "Free Gary" Movement

<figure><img src="/files/byVq6PeSaZ6A6M0ML1ws" alt=""><figcaption></figcaption></figure>

Gary would not have avoided extradition without the very public "Free Gary" movement, championed by British citizens organizing, [FreeGary.org.uk](https://web.archive.org/web/20120520125124/http://www.freegary.org.uk/), the Daily Mail, and his mother Janis Sharp, who wrote a book called *Saving Gary McKinnon.*

<figure><img src="/files/zlfUYnXvj1ftwKzuztPd" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/oHYW895h8RX901nvVWzH" alt=""><figcaption><p>Gary McKinnon's drawing of what he witnessed on a NASA computer in Johnson Space Center building 8.</p></figcaption></figure>

<figure><img src="/files/fVpkpFMgVmAqvzkirgPP" alt=""><figcaption><p>I worked with Gary McKinnon and an artist to render this computer-generated image of what Gary saw on a NASA computer.</p></figcaption></figure>

<figure><img src="/files/ucVKdl8pl3gHWFQhx68t" alt=""><figcaption><p>This image has 8 colors and is 640x480 resolution, as Gary had changed settings to speed up the connection.</p></figcaption></figure>
