...
enhanced_research_prompt = get_prompt("disclosure.enhanced_research")
...
class EnhancedContentAnalysisEngine:
    ...
    async def analyze_content_comprehensive(
        ...
        try:
            ...
            structured_entities = self._extract_structured_entities(
                final_analysis)
    ...
    def _build_consensus_analysis(self, model_results: Dict[str, Any]) -> str:
        ...
        quality_scores = [result['quality_score']
    ...
    def _validate_analysis_quality(
        ...
        has_entities = any(keyword in analysis.lower() for keyword in [
                           'personnel', 'topics', 'events', 'organizations'])
        ...
        metrics['overall_quality_score'] = sum(
            quality_indicators) / len(quality_indicators)
    ...
    def _calculate_confidence_score(
        ...
        quality_score = quality_metrics.get(
            'overall_quality_score', 0.0) if quality_metrics else 0.5
