...
import { Zap, Plus, Save, Share2, Download, Copy, Bookmark, History, Settings, RefreshCw, Upload } from "lucide-react"
...
export function QuickActionsPanel() {
  ...
  return (
    <div className="w-[380px] h-auto flex flex-col bg-neutral-900 text-white shadow-xl border border-neutral-800 rounded-2xl overflow-hidden">
