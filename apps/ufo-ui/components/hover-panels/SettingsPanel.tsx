...
import { Monitor, Moon, Sun, Keyboard, Grid, Save, Settings } from "lucide-react"
...
export function SettingsPanel() {
  ...
  return (
    <PanelWrapper texture="paper" className="w-[360px]">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Save size={16} className="text-neutral-400" strokeWidth={2} />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Grid size={16} className="text-neutral-400" strokeWidth={2} />
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-neutral-400">{canvasZoom[0]}%</span>
                </div>
                <Slider
                  value={canvasZoom}
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue="high">
                  <SelectTrigger className="bg-white/5 border-neutral-700/50">
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="space-y-2">
              {shortcuts.map((shortcut, index) => (
                <div key={index} className="flex items-center justify-between p-2 rounded-lg hover:bg-white/5">
                  ...
                  <kbd className="px-2 py-1 text-xs bg-white/5 rounded border border-neutral-700/50">
                    {shortcut.keys}
                  </kbd>
                </div>
              ))}
