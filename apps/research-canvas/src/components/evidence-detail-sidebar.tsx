...
import { X, FileText, Link, Clock, AlertCircle, Share2 } from "lucide-react"
...
export default function EvidenceDetailSidebar({ isOpen, evidence, onClose }: EvidenceDetailSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Folder Tab - only visible when sidebar is closed */}
      ...
      <motion.div
        ...
        className="fixed inset-y-0 top-0 right-0 z-50 w-full max-w-md border-l border-neutral-800 bg-black/90 backdrop-blur-md h-screen"
      >
        <div className="h-full w-full inset-y-0 absolute opacity-20 -z-5 bg-[url('https://www.transparenttextures.com/patterns/graphy.png')]"></div>

        {/* Folder Tab - visible even when sidebar is closed */}
        <motion.div
          className="fixed top-24 -left-10 w-10 h-32 bg-black/90 backdrop-blur-md border-t border-l border-b border-neutral-800 rounded-l-md flex items-center justify-center cursor-pointer z-50"
          initial={{ x: 0 }}
          animate={{ x: isOpen ? 0 : 100 }}
          exit={{ x: 100 }}
          onClick={onClose}
        ...
        >
          <div className="flex flex-col items-center gap-2 p-1"></div>
        </motion.div>

        <div className="flex h-full flex-col">
          {/* Header */}
          <div className="flex items-center justify-between border-b border-neutral-800 px-6 py-4 relative z-50">
          ...
          <ScrollArea className="flex-1 px-6 py-4">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="h-48 rounded-lg border border-neutral-800 bg-neutral-900/50">
