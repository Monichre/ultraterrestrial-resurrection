...
const ROLE_ICONS = {
  owner: <Crown size={12} className="text-amber-400" strokeWidth={2} />,
  editor: <Edit size={12} className="text-blue-400" strokeWidth={2} />,
  viewer: <Eye size={12} className="text-neutral-400" strokeWidth={2} />,
}
...
export function CollaborationPanel() {
  ...
  return (
    <PanelWrapper texture="fabric" className="w-[380px]">
      ...
      <div className="p-3 space-y-4 overflow-y-auto max-h-96">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              ...
              className="flex-1 h-8 bg-white/5 border-neutral-700/50 text-sm"
            />
            <Select value={inviteRole} onValueChange={setInviteRole}>
              <SelectTrigger className="w-24 h-8 bg-white/5 border-neutral-700/50">
                <SelectValue />
              </SelectTrigger>
            ...
            {COLLABORATORS.map((collaborator) => (
              ...
              >
                <div className="relative">
                  ...
                  <div
                    className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border-2 border-neutral-900 ${
                      collaborator.status === "online" ? "bg-emerald-500" : "bg-neutral-500"
                    }`}
                  />
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-neutral-500 truncate">{collaborator.email}</p>
                </div>
          ...
          <div className="space-y-2">
            {RECENT_ACTIVITY.map((activity) => (
              ...
              >
                ...
                {activity.type === "comment" && (
                  <MessageCircle size={14} className="text-emerald-400 mt-0.5" strokeWidth={2} />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="space-y-2 pt-2 border-t border-neutral-800/50">
          ...
          <div className="flex gap-2">
            <Input
              value="https://research.canvas/project/abc123"
              readOnly
              className="flex-1 h-8 bg-white/5 border-neutral-700/50 text-sm"
            />
